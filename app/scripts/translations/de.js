...
tx_notFound_4               : 'Bitte benutzen Sie das DropDown Menü oben-rechts & wählen Sie eine andere Node aus (z.B. `kUSD (Etherscan.io)` oder `kUSD (Infura.io)` oder `kUSD (MyKowalaWallet)`) und prüfen es erneut.',
...
tx_FoundOnChain_3           : '**Wenn sie keine Fehlernachrichten bekommen, wurde ihre Transaktion erfolgreich versendet.** Ihre kUSD oder Tokens sind dort, wohin sie versendet wurden. Wenn Sie die kUSD or Tokens nicht im anderen Wallet / Exchange account sehen können, und es schon mehr als 24 Stunden her ist, seitdem Sie gesendet haben, bitte [Kontaktieren Sie den Service](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Senden Sie den *link* zu ihrer Transaktion und fragen Sie höflich, die Situation anzuschauen.',
...
GEN_Help_12                 : 'Nutze es um dein Wallet bei MyKowalaWallet (oder Mist, Geth, Parity und andere Wallet Clients.) zu öffnen ',
...
TXFEE_Desc                  : 'Die Transaktionsgebühr wird den Miner(n) bezahlt, die Ihre Transaktion in einen Block einschließen. Es wird durch `Gas-Limit` * `Gas-Preis` berechnet. [Du kannst GWEI -> kUSD hier umwandeln](https://testnet-wallet.kowala.io/helpers.html)',
...
NAV_SendEther               : 'Sende kUSD und Tokens ',
...
/* General */
x_Access                    : 'Zugriff ',
x_AddessDesc                : 'Dies ist Ihre "Kontonummer" oder Ihr "Öffentlicher Schlüssel". Sie benötigen diese Adresse, wenn Ihnen jemand kUSD oder Tokens senden möchte. Das Icon ist eine einfache Möglichkeit, die Adresse zu überprüfen ',
x_Address                   : 'Ihre Adresse ',
x_Cancel                    : 'Abbrechen ',
x_CSV                       : 'CSV-Datei (unverschlüsselt) ',
x_Download                  : 'Herunterladen ',
x_Json                      : 'JSON-Datei (unverschlüsselt) ',
x_JsonDesc                  : 'Dies ist die unverschlüsselte Version deines privaten Schlüssels im JSON-Format. Du benötigst daher kein Passwort, aber jeder, der über diese JSON-Datei verfügt, hat ohne Passwort Zugang zu deinem Wallet und dem darin enthaltenen kUSD. ',
...
ADD_Warning_1               : 'Du kannst unter dem "Wallet-Tab" eine Kontoadresse "beobachten", ohne den privaten Schlüssel hochzuladen. Du hast damit **keinen** Zugang zu diesem Wallet und kannst auch keinen kUSD daraus versenden. ',
...
SENDModal_Content_4         : 'HINWEIS: Wenn Sie eine Fehlermeldung erhalten, müssen Sie vermutlich Ihren kUSD-Saldo erhöhen, um die Gas-Kosten des Token-Versands zu bezahlen. Gas wird in kUSD bezahlt. ',
...
TRANS_warning               : 'Wenn Sie die "Nur kUSD" oder "Nur ETC" Funktionen benutzen, erfolgt die Transaktion über einen Vertrag. Einige Dienste haben ein Problem damit diese Transaktionen zu empfangen. Mehr lesen. ',
TRANS_advanced              : '+Fortgeschritten: Daten hinzufügen ',
TRANS_data                  : 'Daten ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Eine Standard Transaktion mit 21000 Gas kostet 0.000441 kUSD. Wir zahlen einen minimal höheren Gaspreis von 0.000000021 kUSD um zu garantieren, dass die Transaktion schnell bearbeitet wird. Wir erheben keine Transaktionsgebühren. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Nur kUSD" und "Nur ETC" Transaktionen ',
TRANSModal_Content_0        : 'Ein Hinweis zu den verschiedenen Transaktionen und Angeboten ',
TRANSModal_Content_1        : '**kUSD (Standard Transaktion): ** Dies erzeugt eine Standard Transaktion direkt von einer Adresse zu einer anderen. Diese nutzt standardmässig 21000 Gas. Es ist gut möglich, dass alle Transaktionen dieser Art auf der ETC Blockchain wiederholt werden (Replay Attacke). ',
TRANSModal_Content_2        : '**Nur kUSD: ** Dies sendet die Transaktion so über [Timon Rapp\'s "replay protection contract" (wie von VB empfohlen)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/), dass sie nur auf der **kUSD** Blockchain ausgeführt wird. ',
...
MYWAL_Content_3             : 'Wenn Sie dieses Wallet in Zukunft mit MyKowalaWallet CX verwenden wollen, müssen Sie es mittels des privaten Schlüssels/JSON Datei und Ihrem Passwort manuell wieder hinzufügen. ',
...
SWAP_init_2                 : " gegen ", // "I want to swap my X kUSD for X BTC"
...
SWAP_progress_3             : "Erhalten! ", // kUSD Received!
SWAP_progress_4             : "Sende Ihre {{orderResult.output.currency}} ",
SWAP_progress_5             : "Auftrag erfüllt ", //Vielleicht erledigt!
SWAP_order_CTA              : "Bitte sende ", // Please send 1 kUSD...
SWAP_unlock                 : "Schalten Sie Ihr Wallet frei um kUSD oder Tokens direkt von dieser Seite aus zu senden ",
...
ADD_Ledger_0a               : 'Please use MyKowalaWallet on a secure (SSL / HTTPS) connection to connect. ',
ADD_Ledger_0b               : 'Re-open MyKowalaWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Re-open MyKowalaWallet on a secure (SSL) connection ',
ADD_DigitalBitbox_0b        : 'Re-open MyKowalaWallet using [Chrome](https://www.google.com/chrome/browser/desktop/) or [Opera](https://www.opera.com/) ',
...
ERROR_17                    : 'Unzureichendes Guthaben für Gasverbrauch * Gaspreis + Wert. Du brauchst **0.01 kUSD** in deinem Account um die Gaskosten zu decken. Bitte füge kUSD hinzu und versuche es noch einmal. ',
...
ERROR_28                    : '**Du benötigst deine Keystore-Datei & das Passwort** (oder den privaten Schlüssel) um künftig auf dein Wallet zugreifen zu können. Bitte sichere diese Datei daher auf einem externen Medium! Es gibt KEINE Möglichkeit, ein Wallet wiederherzustellen, wenn du diese Datei und das Passwort nicht sicherst. Lies die [Hilfe-Seite](https://testnet-wallet.kowala.io/#help) für weitere Informationen. ',
...
TranslatorName_2            : '[mawalu](https://testnet-wallet.kowala.io/?gaslimit=21000&to=0xA6e9A24981aFB71f96C7330618139a7B34BCdEc3&value=1.0#send-transaction) · ',
TranslatorAddr_2            : '0xA6e9A24981aFB71f96C7330618139a7B34BCdEc3 ',
/* Translator 2             : Insert Comments Here */
TranslatorName_3            : '[huhn_solo](https://testnet-wallet.kowala.io/?gaslimit=21000&to=0x1DAd1765381460db9A44846cDfA6f74c65A06B77&value=1.0#send-transaction) · ',
TranslatorAddr_3            : '0x1DAd1765381460db9A44846cDfA6f74c65A06B77 ',
/* Translator 3             : Insert Comments Here */
TranslatorName_4            : '[FelixA](https://testnet-wallet.kowala.io/?gaslimit=21000&to=0xb6999051b0Bfad32E192e107181E0ac72bE7EE3D&value=1.0#send-transaction) · ',
TranslatorAddr_4            : '0xb6999051b0Bfad32E192e107181E0ac72bE7EE3D ',
/* Translator 4             : Insert Comments Here */
TranslatorName_5            : 'danielsun174 · ffidan61 · [u/Preisschild](https://testnet-wallet.kowala.io/?gaslimit=21000&to=0x700Eb9142a0CC709fce80709cfbF5Ac25438c584&value=0.1#send-transaction) ',
TranslatorAddr_5            : '',
...
HELP_Remind_Desc_1          : '**Ethereum, testnet-wallet.kowala.io & MyKowalaWallet CX, sowie einige der verwendeten Javascript Bibliotheken, die wir verwenden, befinden sich noch in Entwicklung.** Zwar haben wir alles umfassend getestet und es wurden erfolgeich tausende Wallets von Menschen aus aller Welt kreiert, jedoch bestimmt immer eine gewisse Gefahr, dass etwas unerwartetes passiert und dein kUSD verloren geht. Bitte investiere nicht mehr als du verlieren kannst, und sei immer vorsichtig. Sollte etwas schlimmes passieren, **können wir uns leider nicht verantwortlich für einen Verlust zeichnen**. ',
HELP_Remind_Desc_2          : 'testnet-wallet.kowala.io & MyKowalaWallet CX sind keine "web wallets". Du erstellst keinen Account oder sendest uns kUSD den wir halten. Alle Daten bleiben auf deinem Computer, bzw. Browser. Unser Auftrag ist es, dir das Erstellen, Speichern und Zugreifen auf deine Accounts zu vereinfachen, sowie dir eine simple Möglichkeit zur Interaktion mit der Blockchain zu bieten. ',
...
HELP_0_Desc_1               : 'MyKowalaWallet bietet dir die Möglichkeit neue Wallets zu generieren, damit du deinen kUSD selbst speichern kannst, und keine Exchange nutzen musst. Dieser Prozess findet ausschließlich auf deinem Computer statt. Daher bist auch **du dafür Verantwortlich, Back-ups zu erstellen** wenn du ein Wallet verwenden möchtest. ',
...
HELP_0_Desc_5               : 'Überweise kUSD auf das neue Wallet. ',
...
HELP_2a_Desc_2              : 'Speichere die Adresse. Du kannst sie für dich behalten oder mit anderen teilen. Auf diese Adresse können andere kUSD an dich senden. ',
HELP_2a_Desc_3              : 'Speiche verschiedene Versionen deines privaten Schlüssels. Teile ihn nicht mit jemand anderem. Dein privater Schlüssel ist notwendig, wenn du auf deinen kUSD zugreifen willst, um eine Überweisung zu tätigen! Es gibt 3 Arten des privaten Schlüssels ',
...
HELP_4_Title                : '4) Wie kann ich kUSD von einer Wallet zur anderen senden? ',
...
HELP_4_Desc_2               : 'Navigate to the "Sende kUSD und Tokens" page. ',
...
HELP_4CX_Title              : '4) Wie kann ich kUSD über MyKowalaWallet CX senden? ',
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Sende kUSD und Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Sende kUSD und Tokens" Page ',

HELP_5_Title                : '5) Wie kann ich testnet-wallet.kowala.io offline/lokal starten? ',
...
HELP_7_Desc_1               : 'Navigate to the "Sende kUSD und Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Sende kUSD und Tokens" page offline? ',
