...
tx_notFound_4               : 'Gebruik het drop-down menu in de rechterbovenhoek & selecteer een andere kUSD node (bijvoobeeld `kUSD (Etherscan.io)` of `kUSD (Infura.io)` of `kUSD (MyKowalaWallet)`) en check opnieuw.',
...
GEN_Help_12                 : 'Gebruik het enkel om je wallet te openen via MyKowalaWallet (of Mist, Geth, Parity en andere wallet clients.) ',
...
GAS_LIMIT_Desc              : 'Gas limiet is de hoeveelheid gas waarmee je je TX verstuurd. `TX vergoeding = gas prijs * gas limiet` & wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. Het verhogen van dit nummer zorgt er niet voor dat je TX sneller ge-mined zal worden. Verzenden van kUSD = `21000`. Verzenden van Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'De TX vergoeding (`fee`) wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. De vergoeding is de `gas limiet` * `gas prijs`. [Je kunt hier GWEI -> kUSD converteren](https://testnet-wallet.kowala.io/helpers.html)',
...
NAV_SendEther               : 'Verzend kUSD & Tokens ',
...
x_AddessDesc                : 'Je Adres wordt ook wel je `Account #` of je Publieke Sleutel ("Public Key") genoemd. Dit is wat je deelt met anderen zodat ze je kUSD of Tokens kunnen toesturen. Zie ook je kleurrijke adres icoon. Zorg ervoor dat het matched met je paper wallet & waar dan ook wanneer je je adres ergens invoerd. Dit icoon is een makkelijke manier om je adres te herkennen. ',
x_Address                   : 'Je Adres ',
x_Cancel                    : 'Annuleren ',
x_CSV                       : 'CSV bestand (onversleuteld) ',
x_Download                  : 'Download ',
x_Json                      : 'JSON Bestand (onversleuteld) ',
x_JsonDesc                  : 'Dit is het onversleutelde, JSON formaat van je prive sleutel ("Private Key"). Dit betekend dat je het wachtwoord niet nodig hebt, maar ook dat een ieder die je JSON bestand vind toegang heeft tot je wallet & kUSD zonder wachtwoord. ',
...
/* Header */
CX_Tagline                  : 'Open Source JavaScript Client-Side kUSD Wallet Chrome Extensie ',
...
ADD_Ledger_0a               : 'Her-open MyKowalaWallet met een veilige (SSL) verbinding ',
ADD_Ledger_0b               : 'Her-open MyKowalaWallet door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
ADD_Ledger_scan             : 'Verbind met Ledger Wallet ',
x_Trezor                    : 'TREZOR ',
ADD_Trezor_scan             : 'Verbind met TREZOR ',
ADD_MetaMask                : 'Verbind met MetaMask ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Her-open MyKowalaWallet met een veilige (SSL) verbinding ',
ADD_DigitalBitbox_0b        : 'Her-open MyKowalaWallet door gebruik te maken van [Chrome](https://www.google.com/chrome/browser/desktop/) of [Opera](https://www.opera.com/) ',
...
ADD_Warning_1               : 'Je kunt elk account toevoegen als "bekijken" in het wallets tabblad zonder de prive sleutel te uploaden. Dit betekend ** niet ** dat je toegang hebt tot deze wallet, noch dat je er kUSD vanuit kunt versturen. ',
...
MYWAL_Content_3             : 'Als je deze wallet in de toekomst nog wilt gebruiken met MyKowalaWallet CX, zul je het met de hand moeten toevoegen door gebruik te maken van de prive sleutel/JSON en wachtwoord. ',
...
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Een standaard transactie met 21000 gas zal 0.000441 kUSD kosten. Wij gebruiken een iets-boven-minimum gas prijs van 0.000000021 kUSD om te garranderen dat de transactie snel uitgevoerd zal worden. Wij zijn niet verantwoordelijk voor je transactie kosten. ',
...
NODE_Warning                : 'Je node dient HTTPS te zijn om met testnet-wallet.kowala.io te kunnen verbinden. Je kunt de [MyKowalaWallet repo downloaden](https://github.com/kvhnuke/etherwallet/releases/latest) en lokaal uitvoeren en vervolgens met iedere node verbinden. Of, verkrijg een gratis SSL certificaat via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Naam',
...
SWAP_init_2                 : " omwisselen voor ", // "I want to swap my X kUSD for X BTC"
...
SWAP_progress_3             : "Ontvangen! ", // kUSD Received!
SWAP_progress_4             : "Verzenden van je {{orderResult.output.currency}} ",
SWAP_progress_5             : "Bestelling Voltooid ",
SWAP_order_CTA              : "Verzend alsjeblieft ", // Please send 1 kUSD...
SWAP_unlock                 : "Open je Wallet op deze pagina om kUSD of Tokens direct te verzenden. ",
...
ERROR_28                    : '**Je hebt je Keystore Bestand & wachtwoord of prive sleutel nodig** om toegang tot deze wallet te verkrijgen in de toekomst. Sla het op & maak een externe back-up! Er is geen enkele manier om je wallet te herstellen als je het nu niet opslaat. Lees ook de help pagina (https://testnet-wallet.kowala.io/#help) voor instructies. ',
...
TranslatorName_1            : '[h3ll0fr13nd](https://testnet-wallet.kowala.io/?gaslimit=21000&to=0xB5FbCE123F12347206c881cae73A3046BA1A90bA&value=1.0#send-transaction) ',
...
HELP_Remind_Desc_1          : '**Ethereum, testnet-wallet.kowala.io & MyKowalaWallet CX, en enkele onderliggende Javascript libraries waar we gebruik van maken zijn onderheving aan active ontwikkeling.** Hoewel we grondig testen & er inmiddels tienduizenden wallets succesvol zijn aangemaakt door mensen over de hele wereld, blijft er altijd een geringe kans dat iets er onverwachts optreedt waardoor je je ether kunt verliezen. Investeer alsjeblieft niet meer dan dat je bereid bent om te verliezen, en wees voorzichtig. Zou er onverhoopt toch iets gebeuren vinden we dat zeer spijtig, echter **zullen wij nooit verantwoordelijk zijn voor de verloren kUSD**. ',
HELP_Remind_Desc_2          : 'testnet-wallet.kowala.io & MyKowalaWallet CX zijn geen "web wallets". Je maakt bij ons geen account aan noch geef je ooit je kUSD aan ons in bezit. Alle gegevens verlaten nooit je computer/je browser. We helpen je alleen gemakkelijk toegang te verkrijgen tot de blockchain zodat je er informatie in kunt opslaan en kunt uitlezen. ',
...
HELP_0_Desc_5               : 'Verzend kUSD naar dit nieuwe wallet. ',
...
HELP_2a_Desc_3              : 'Bewaar versies van je prive sleutel. Deel deze niet met anderen. Je prive sleutel heb je nodig wanneer je toegang tot je kUSD wilt om het te versturen! Er zijn drie soorten prive sleutels: ',
...
HELP_2b_Title               : '2b) Hoe doe ik veilig / offline / cold storage met MyKowalaWallet? ',
...
HELP_3_Desc_1               : 'Zorg **voordat je enige kUSD naar je wallet verstuurd** dat je controleerd dat je er toegang toe hebt. ',
HELP_3_Desc_2               : 'Navigeer naar de "Bekijk Wallet Info" pagina. ',
HELP_3_Desc_3               : 'Navigeer naar de testnet-wallet.kowala.io "Bekijk Wallet Info" pagina. ',
...
HELP_4_Title                : '4) Hoe stuur ik kUSD van het ene wallet naar het ander? ',
...
HELP_4_Desc_2               : 'Navigeer naar de "Verzend kUSD en Tokens" pagina. ',
...
HELP_4CX_Title              : '4) Hoe verzend ik kUSD met MyKowalaWallet CX? ',
HELP_4CX_Desc_1             : 'Ten eerste heb je een wallet nodig. Zodra je die hebt, heb je 2 opties: De "VerzendSnel" functionaliteit vanuit het Chrome Extensie icoon of de "Verzend kUSD en Tokens" pagina. ',
...
HELP_4CX_Desc_12            : 'Maak gebruik van de "Verzend kUSD en Tokens" Pagina ',

HELP_5_Title                : '5) Hoe voer ik testnet-wallet.kowala.io offline/lokaal uit? ',
HELP_5_Desc_1               : 'Je kunt testnet-wallet.kowala.io uitvoeren op je eigen computer in plaats van op de GitHub servers. Je kunt een wallet volledig offline genereren en transacties versturen met behulp van de "Offline Transactie" pagina. ',
HELP_5_Desc_7               : 'testnet-wallet.kowala.io draait nu volledig op jouw computer. ',
HELP_5_Desc_8               : 'Voor het geval dat je er niet bekend mee bent: je hebt de volledige map nodig om de site lokaal te draaien, niet alleen het `index.html` bestand. Laat alle bestanden in de map met rust en ga ze niet verplaatsen. Als je een back-up wilt bewaren van de MyKowalaWallet repo voor de toekomst, raden we je aan om alleen de ZIP te bewaren zodat je zeker weet dat de inhoud intact blijft. ',
HELP_5_Desc_9               : 'Gezien we testnet-wallet.kowala.io continu updaten, raden we je aan om regelmatig je opgeslagen versie van de repo bij te werken. ',
...
HELP_8_Desc_1               : 'MyKowalaWallet is geen web wallet. Je hoeft niet in te loggen en er zal nooit iets van je op onze servers worden bewaard. Onze website is enkel een interface om toegang te verkrijgen tot de blockchain. ',
HELP_8_Desc_2               : 'Als testnet-wallet.kowala.io er mee stopt, zul je een andere manier moeten zien te vinden (zoals geth of Ethereum Wallet / Mist) om te doen wat wij doen. Maar wat je niet zult hoeven te doen is je kUSD uit MyKowalaWallet halen omdat het niet in MyKowalaWallet zit. Je kUSD zit in in welk wallet dan ook je op onze site hebt gegenereerd. ',
...
HELP_8CX_Desc_2             : 'Dat gezegd hebbende, is het dan ook **erg belangrijk** dat je een back-up maakt van je wallets die met MyKowalaWallet CX zijn gegenereerd. Als er iets met MyKowalaWallet CX of jouw computer gebeurd blijft op die manier je wallet bewaard, en heb alle noodzakelijke informatie bij de hand om toegang tot je kUSD te verkrijgen. Zie vraag #2a om te leren hoe een back-up van je wallet kunt maken. ',
HELP_8CX_Desc_3             : 'Als om wat voor reden dan ook MyKowalaWallet CX verdwijnt van de Chrome Store, kunt je het altijd nog handmatig laden met de broncode van Github. Zie #5 hierboven. ',

HELP_9_Title                : '9) Is de "Verzend kUSD en Tokens" pagina offline? ',
...
HELP_12_Title               : '12) Hoe importeer ik een MyKowalaWallet  wallet in geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Door gebruik te maken van een Geth/Mist JSON bestand van MyKowalaWallet v2+.... ',
...
HELP_13_Desc_1              : 'Dit betekend dat je account onvoldoende kUSD bevat om de kosten voor het vereiste gas te dekken. Elke transactie (inclusief token en contract transacties) vereisen gas en dit gas wordt betaald in kUSD. Het weergegeven nummer is de hoeveelheid die voor de transactie vereist in Wei. Neem dit nummer, deel het door `1000000000000000000`, en trek daarvan de hoeveelheid kUSD die je probeerde te verzenden af (als je probeerde kUSD te versturen). Dit geeft je de hoeveelheid kUSD die je dient te versturen naar het account om de transactie te maken. ',

HELP_14_Title               : '14) Sommige sites zorgen voor een willekeurigheid (seed) bij het genereren van de prive sleutel via muis bewegingen. testnet-wallet.kowala.io doet dit niet. Is de wikkeleurigheid (random number generation) van MyKowalaWallet wel veilig? ',
HELP_14_Desc_1              : 'Hoewel het bewegen van de muis een slimme truck is en we begrijpen waarom mensen dit een goed idee vinden, is de werkelijkheid dat "window.crypto" een grotere willekeurigheid (hogere entropie) zeker stelt dan je muisbewegingen. De muisbewegingen zijn niet onveilig, echter wij (en enorm veel andere crypto experimenten) geloven in "window.crypto". Bovendien kan testnet-wallet.kowala.io gebruikt worden op touchscreen apparaten. Hier vind je een [conversatie tussen een boze redditor en Vitalik Buterin over de muisbewegingen v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_15_Desc_1              : 'Adresen zullen enkel in een blockchain explorer worden weergegeven zodra er activiteit op een account heeft plaats gevonden. Bijvoorbeeld, zodra je er wat kUSD naar toe verzonden hebt. ',
...
HELP_SecCX_Title            : 'Beveiliging - MyKowalaWallet CX ',
...
HELP_SecCX_Desc_6           : 'Als we deze items zouden versleutelen, zou je iedere keer dat je je saldo of nicknames wilt checken je wachtwoord moeten invoeren. Als je je hierover zorgen maakt, raden we je aan om gebruik te maken van testnet-wallet.kowala.io in plaats van deze Chrome Extensie. ',
...
HELP_Sec_Desc_4             : 'Controleer de URL -- Deze website draait vanaf GitHub en je kunt de bron code hier vinden: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) naar de domein namen: [https://testnet-wallet.kowala.io](https://testnet-wallet.kowala.io). ',
