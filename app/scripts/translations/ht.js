...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud kUSD différent (par ex. `kUSD (Etherscan.io)` ou `kUSD (Infura.io)` ou `kUSD (MyKowalaWallet)`) et revérifiez.',
...
tx_FoundOnChain_3           : '**Si vous ne voyez pas d\'erreur, votre transaction a été envoyée avec succès.** Vos kUSD ou Tokens sont à l\'endroit où vous les avez envoyés. Si vous ne voyez pas ces kUSD ou Tokens dans votre autre portefeuille ou compte de place d\'échange, et si cela fait plus de 24 heures, veuillez [contacter ce service](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Envoyez-leur le *lien* vers votre transaction et demandez, poliment, d\'examiner votre situation.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec MyKowalaWallet (ou Mist, Geth, Parity et autres wallet clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `gas limit` * le `gas price`. [Vous pouvez convertir GWEI -> kUSD ici](https://testnet-wallet.kowala.io/helpers.html)',
...
/* Header */
CX_Tagline                  : 'EKSTANSYON CHROME BOUS d\'kUSD Open Source JavaScript POU KLIYAN  AN ',
...
MEW_Tagline                 : 'BOUS d\'kUSD Open Source JavaScript POU KLIYAN AN ',
...
MYWAL_Content_3             : 'SI W’ VLE SÈVI AK BOUS SA  AVÈK MyKowalaWallet CX NAN LÒT JOU YO, OU DWE METE L’ ANKÒ  SÈVI AK KLE SEKRÈ A /PAJ JSON AK KÒD SEKRÈ A ',
...
/* full sentence reads "You are about to send "10 kUSD" to address "0x1234". Are you sure you want to do this? " */                                                                                                  /*PLEN FRAZ POU LI ‘’ OU PRAL VOYE L’ ‘’10ETH’’ NAN ADRÈS ‘’0X1234’’ ESKE W’ KONFYAN OU VLE FÈ SA ?’’*/
...
TRANS_warning               : 'METE FONKSYON ‘’kUSD’’ YO SÈLMAN  AK ‘’ETC SÈLMAN’’ OU FÈ W’ PASE NAN YON KONTRA. KÈK NAN SÈVIS SA YO KONN GEN PWOBLÈM  AK TRANSFÈ SA YO. POU W’  KONN PLIS ',
TRANS_advanced              : '+AVANSE : METE GAZ ',
TRANS_data                  : 'DONE ',
TRANS_gas                   : 'LIMIT AN GAZ ;// CHANJE AN ENG POU LIMIT GAZ LA ',
TRANS_sendInfo              : 'YON TRANSFÈ NÒMAL SÈVI  AK 21000 GAZ KI KOUTE 0.000441  kUSD. PRI GAZ LA 0.000000021 kUSD  KE NOU TE CHWAZI A ON TI JAN PI WO KE  PI PITI A ASIRE W’ POU W’ YON KONFIMASYON RAPID. NOU PA PRAN FRÈ POU TRANSFÈ A.  ',
...
SWAP_init_2                 : 'POU ', //M’ VLE CHANJE X kUSD POU X BTC '
...
SWAP_progress_3             : ', // kUSD Received! kUSD RESEVWA ! ',
SWAP_progress_4             : 'VOYE {{REZILTA LÒD. KREYASYON.MONNEN}} YO ',
SWAP_progress_5             : 'LÒD AKONPLI ',
SWAP_order_CTA              : 'TANPRI VOYE 1 kUSD ',
SWAP_unlock                 : 'OUVRI BOUS OU A POU W’ VOYE kUSD YO OSWA TOKENS YO SÒTI DIRÈKTEMAN NAN SA ',
...
ERROR_28                    : '**OU BEZWEN PAJ KEYSTORE W’ LA EPI KÒD SEKRÈ A ** ( OSWA KLE SEKRÈ W’ LA) POU KAPAB ANTRE NAN BOUS SA NAN LÒT JOU YO. TANPRI PRAN L’EPI  POU W’ SERE L’ YON KOTE DEYÒ ! PA GEN OKENN LÒT MWAYEN POU W’ JWENN ANKÒ YON BOUS SI W’ PA ANREJISTRE L’. TANPRI LI PAJ SA [PAJ POU EDE](https://testnet-wallet.kowala.io/#help) POU DETAY YO ',
...
TranslatorName_1            : '[Nogo10](https://testnet-wallet.kowala.io/?gaslimit=21000&to= 0x152e77CC3Dd8d86471ebEa8e93B9924A41e7055a&value=1.0#VOYE-TRANSFÈ A) · ',
...
HELP_SecCX_Desc_6           : 'SI NOU TA DWE METE KÒD NAN ENFÒMASYON YO, FÒK OU TA ANTRE YON KÒD SEKRÈ NAN CHAK MOMAN OU BEZWEN WÈ LAJAN SOU KONT OU OSWA LÒT TI NON YO. SI SA NWI W’,NOU MANDE W’ POU SÈVI AK testnet-wallet.kowala.io KE EXTENSION CHROME SA. ',
...
HELP_Sec_Desc_4             : 'VERIFYE URL LA – SIT SA SÈVI AK GITHUB EPI OU KAPAB WÈ KÒD SOUS LA LA : : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) NAN  [https://testnet-wallet.kowala.io](https://testnet-wallet.kowala.io). ',
