...
tx_notFound_4               : 'กรุณาใช้กล่อง dropdown ที่มุมขวาบน & เลือก kUSD Node อื่น (เช่น `kUSD (Etherscan.io)` หรือ `kUSD (Infura.io)` หรือ `kUSD (MyKowalaWallet)`) และตรวจสอบอีกครั้ง',
...
GEN_Help_12                 : 'ใช้เพื่อปลดล็อกกระเป๋าของคุณผ่าน MyKowalaWallet (หรือ Mist, Geth, Parity หรือโปรแกรมกระเป๋าอื่นๆ) ',
...
GAS_LIMIT_Desc              : 'จำนวนจำกัดแก๊ส คือปริมาณของแก๊สที่จะส่งไปกับธุรกรรม (TX) ของคุณ `ค่าธรรมเนียม TX = ราคาแก๊ส * จำนวนจำกัดแก๊ส และจะถูกจ่ายให้กับผู้ขุดที่ขุด TX ของคุณลงในบล็อค การเพิ่มจำนวนนี้จะไม่ทำให้ TX ของคุณถูกขุดสำเร็จไวขึ้น การส่ง kUSD = `21000` หากส่ง Token = ~`200000`',
...
TXFEE_Desc                  : 'ค่าธรรมเนียมธุรกรรม (TX) จะถูกจ่ายให้กับผู้ขุดที่ขุด TX ของคุณลงในบล็อค มีค่าเท่ากับ `จำนวนจำกัดแก๊ส` * `ราคาแก๊ส` [คุณสามารถแปลง GWEI -> kUSD ได้ที่นี่](https://testnet-wallet.kowala.io/helpers.html)',
...
/* General */
x_Access                    : 'เข้าใช้ ',
x_AddessDesc                : 'ที่อยู่ของคุณ หรือสามารถเรียกอีกอย่างว่า `Account #` หรือ `กุญแจสาธารณะ (Public Key)` คือสิ่งที่คุณสามารถแชร์ให้ผู้อื่น เพื่อรอรับ kUSD หรือ Token ได้ เพียงมองหาไอคอนของที่อยู่และตรวจสอบให้แน่ใจว่ามันตรงกับกระเป๋ากระดาษของคุณ หรือเมื่อใดก็ตามที่คุณป้อนที่อยู่ของคุณ',
x_Address                   : 'ที่อยู่ของคุณ ',
x_Cancel                    : 'ยกเลิก ',
x_CSV                       : 'ไฟล์ CSV (ไม่ได้ถูกเข้ารหัส) ',
x_Download                  : 'ดาวน์โหลด ',
x_Json                      : 'ไฟล์ JSON (ไม่ได้ถูกเข้ารหัส) ',
x_JsonDesc                  : 'เนื้่อหานี้ไม่ถูกเข้ารหัส ซึ่งเป็น กุญแจส่วนตัว (Private Key) ของคุณที่อยู่รูปแบบ JSON ซึ่งหมายความว่าผู้อื่นที่เข้าถึง JSON นี้ จะสามารถเข้าถึงกระเป๋า & kUSD ของคุณได้โดยไม่จำเป็นต้องรู้รหัสผ่านเลย ',
...
/* Header */
CX_Tagline                  : 'โอเพ่นซอร์ส JavaScript ฝั่งไคลเอนต์สำหรับสร้างกระเป๋า kUSD ผ่าน Chrome Extension ',
...
MEW_Tagline                 : 'โอเพ่นซอร์ส JavaScript ฝั่งไคลเอนต์สำหรับสร้างกระเป๋า kUSD ',
...
sidebar_donation            : 'MyKowalaWallet ให้บริการฟรี, และเป็นโอเพ่นซอร์สเพื่อความเป็นส่วนตัว และความปลอดภัยของคุณ ยิ่งเราได้รับการบริจาคมากเท่าไหร่เราก็ยิ่งมีเวลาเพื่อสร้างฟีเจอร์ใหม่ๆ มากขึ้นเท่านั้น, พร้อมรับฟังข้อเสนอแนะ, และตอบสนองตามความต้องการของผู้ใช้ ซึ่งเราเป็นแค่ทีมสองคนที่อยากจะเปลี่ยนแปลงโลกใบนี้ สนใจช่วยเราไหม? ',
...
ADD_Ledger_0a               : 'คุณต้องเข้าใช้ MyKowalaWallet ผ่านทางการเชื่อมต่อที่ปลอดภัย (SSL / HTTPS) ถึงจะสามารถเชื่อมต่อได้ ',
ADD_Ledger_0b               : 'เปิด MyKowalaWallet อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'เปิด MyKowalaWallet อีกครั้งผ่านการเชื่อมต่อที่ปลอดภัย (SSL) ',
ADD_DigitalBitbox_0b        : 'เปิด MyKowalaWallet อีกครั้งด้วย [Chrome](https://www.google.com/chrome/browser/desktop/) หรือ [Opera](https://www.opera.com/) ',
...
ADD_Warning_1               : 'คุณสามารถเพิ่มบัญชีเข้า "รายการติดตาม" จากแท็บของกระเป๋าโดยไม่ต้องอัพโหลด private key ซึ่งการกระทำนี้ ** ไม่ได้ ** หมายความว่าคุณสามารถเข้าถึงกระเป๋านี้ได้ หรือสามารถส่ง kUSD ออกจากกระเป๋าได้ ',
...
MYWAL_Content_3             : 'ถ้าหากคุณต้องการจะใช้กระเป๋านี้ร่วมกับ MyKowalaWallet CX ในอนาคต คุณจำเป็นจะต้องเพิ่มกระเป๋าใหม่อีกครั้งด้วย private key/JSON และรหัสผ่าน ',
...
SENDModal_Content_4         : 'หมายเหตุ: หากคุณพบข้อผิดพลาด โดยส่วนใหญ่แล้วคุณจำเป็นที่จะต้องเพิ่ม kUSD เข้าบัญชีเพื่อใช้เป็นค่าแก๊สในการส่ง Token และค่าแก๊สจะถูกจ่ายด้วย kUSD ',
...
TRANS_sendInfo              : 'ธุรกรรมโดยทั่วไปจะใช้ค่าแก๊สจำนวน 21000 แก๊ส ซึ่งมีมูลค่าเท่ากับ 0.000441 kUSD เราจะใช้ค่าแก๊สที่สูงกว่าทั่วไปอีก 0.000000021 kUSD เพื่อทำให้แน่ใจว่าธุกรรมถูกขุดอย่างรวดเร็ว เราไม่ได้เป็นผู้รับค่าธรรมเนียมในการทำธุรกรรม ',
...
SWAP_init_2                 : " ของฉันด้วย ", // "I want to swap my X kUSD for X BTC"
...
SWAP_progress_3             : "ได้รับแล้ว! ", // kUSD Received!
SWAP_progress_4             : "กำลังส่ง {{orderResult.output.currency}} ",
SWAP_progress_5             : "คำสั่งสำเร็จ ",
SWAP_order_CTA              : "กรุณาส่ง ", // Please send 1 kUSD...
SWAP_unlock                 : "ปลดล็อกกระเป๋าของคุณเพื่อส่ง kUSD หรือ Token ได้โดยตรงจากหน้านี้ ",
...
ERROR_17                    : 'มียอดคงเหลือไม่พอในบัญชีที่คุณกำลังจะส่งออก ถ้าหากคุณกำลังจะส่ง Token คุณจะต้องมีอย่างน้อย 0.01 kUSD อยู่ในบัญชีของคุณ เพื่อใช้เป็นค่าแก๊ส ', // 17
...
TranslatorName_1            : '[Tianissimo (Suteepat)](https://testnet-wallet.kowala.io/?gaslimit=21000&to=0x8d0a185C16ADE28bf69Cb38c5e3df605360df40e&value=1.0#send-transaction) ',
