...
tx_notFound_4               : 'Bruk rullegardinmenyen øverst til høyre og velg en annen kUSD-node. (f.eks. `kUSD (Etherscan.io)` eller `kUSD (Infura.io)` eller `kUSD (MyKowalaWallet)`), og sjekk igjen.',
...
tx_FoundOnChain_3           : '**Hvis du ikke ser noen feil, var transaksjonen vellykket.** Dine kUSD eller Tokens er der du sendte dem. Hvis du ikke ser disse kUSD eller Tokens der du sendte dem, og det har gått mer enn 24 timer, vennligst [kontakt vedkommende service](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Send dem en *lenke* til transaksjonen din og spør dem pent om å se på situasjonen din.',
...
GEN_Help_12                 : 'Bruk den sammen med passordet du oppga til å låse opp lommeboken din via MyKowalaWallet (eller Mist, Geth, Parity og andre lommebok-klienter.) ',
...
TXFEE_Desc                  : 'Transaksjonsavgiften betales til "utgraverne" for å inkludere transaksjonen din i en blokk. Det er `gas-grense` * `gas-pris`. [Du kan regne om GWEI -> kUSD her](https://testnet-wallet.kowala.io/helpers.html)',
...
NAV_SendEther               : 'Send kUSD & Tokens ',
...
/* General */
x_Access                    : 'Åpne ',
x_AddessDesc                : 'Din `adresse` kalles også for `kontonummer` eller `offentlig nøkkel`. Det er denne du sender til folk så de kan sende deg kUSD eller Tokens. Find det fargerike adresse-ikonet. Forsikre deg om at det er likt med ikonet på papir-lommeboken din og ellers hver gang du oppgir adressen din. ',
...
MEW_Tagline                 : 'Open Source JavaScript Client-Side kUSD Wallet ', /* Intentionally not translated */
CX_Tagline                  : 'Open Source JavaScript Client-Side kUSD Wallet Chrome Extension ', /* Intentionally not translated */
...
ADD_Ledger_0a               : 'Åpne MyKowalaWallet på nytt på en sikker (SSL) forbindelse. ',
ADD_Ledger_0b               : 'Åpne MyKowalaWallet på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Åpne MyKowalaWallet på nytt på en sikker (SSL) forbindelse. ',
ADD_DigitalBitbox_0b        : 'Åpne MyKowalaWallet på nytt med [Chrome](https://www.google.com/chrome/browser/desktop/) eller [Opera](https://www.opera.com/) ',
...
TRANS_warning               : 'Hvis du bruker "Kun kUSD"- eller "Kun ETC"-funksjonene, sender du via en kontrakt. Noen tjenester har problemer med å akseptere disse transaksjonene. Les mer. ',
TRANS_advanced              : '+Avansert: Legg til data ',
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'En standard transaksjon som bruker 21000 gas vil koste 0,000441 kUSD. Vi bruker en litt-over-minimum gas-pris på 0,000000021 kUSD for å sikre at transaksjonen blir raskt behandlet. Vi tar ikke noe transaksjonsgebyr. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Kun kUSD"- og "Kun ETC"-transaksjoner ',
TRANSModal_Content_0        : 'En notis om forskjellige transaksjoner og tjenester: ',
TRANSModal_Content_1        : '**kUSD (Standardtransaksjon): ** Dette Oppretter en standardtransaksjon direkte fra en adresse ti en annen. Den har standard gas på 21000. Det er sannsynlig at kUSD som sendes med denne metoden også vil bli sendt som ETC på ETC-kjeden (hvis kontoen inneholder både kUSD og ETC). Dette er anbefalt metode hvis kontoen kun inneholder kUSD. ',
TRANSModal_Content_2        : '**Kun kUSD: ** Dette sender via [Timon Rapp\'s replay-beskyttelseskontrakt (som anbefalt av VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) slik at du kun sender på **kUSD**-kjeden. ',
...
SWAP_init_2                 : " med ", // "I want to swap my X kUSD for X BTC"
...
SWAP_progress_3             : "Mottatt! ", // kUSD Received!
SWAP_progress_4             : "Sender dine {{orderResult.output.currency}} ",
SWAP_progress_5             : "Ordre fullført ",
SWAP_order_CTA              : "Vennligst send ", // Please send 1 kUSD...
SWAP_unlock                 : "Lås opp din lommebok for å sende kUSD eller Tokens direkte fra denne siden. ",
...
MYWAL_Content_3             : 'Hvis du ønsker å bruke denne lommeboken med din MyKowalaWallet Chrome-utvidelse i fremtiden, må du manuelt legge den til igjen ved å bruke den private nøkkelen/JSON og passord. ',
...
ERROR_28                    : '**Du trenger din Keystore-fil & passord eller din private nøkkel** for å få tilgang til denne lommeboken i framtiden. Vennligst lagre og sikkerhetskopier den eksternt! Det finnes ingen måte å gjenopprette en lommebok på hvis du ikke lagrer den. Les [hjelpesiden](https://testnet-wallet.kowala.io/#help) for ytterligere instruksjoner (foreløpig kun på engelsk). ',
...
TranslatorName_1            : '[mrstormlars](https://testnet-wallet.kowala.io/?gaslimit=21000&to=mrstormlars.eth&value=1.0#send-transaction) ',
TranslatorAddr_1            : '',
...
HELP_Remind_Desc_1          : '**Ethereum, testnet-wallet.kowala.io & MyKowalaWallet CX, og noen av de underliggende Javascript-bibliotekene vi benytter er under aktiv utvikling.** Selv om vi har testet grundig, og titusenvis av lommebøker har blitt opprettet uten feil av folk over hele kloden, så er det alltid en liten mulighet for at noe uventet kan skje som kan medføre at dine kUSD kan tapes. Vennligst ikke invester mer enn du er villig til å tape, and vær så snill å være forsiktig. Hvis noe skulle skje, er vi lei oss for det, men **vi er ikke ansvarlige for eventuelt tapte etere**. ',
HELP_Remind_Desc_2          : 'testnet-wallet.kowala.io & MyKowalaWallet CX er ikke "web wallets" (internettlommebøker). Du oppretter ikke en konto eller gir oss dine ethere for oppbevaring hos oss. Alle data forblir på din PC / i din nettleser. Vi gjør det enkelt for deg å opprette, lagre og få tilgang til din informasjon og samhogle med blokkjeden. ',
...
HELP_1_Desc_1               : 'Gå til "Send kUSD & Tokens"-siden. ',
...
HELP_2b_Title               : '2b) Hvordan kan jeg lagre ether sikkert / offline / "kaldt" med MyKowalaWallet? ',
...
HELP_3_Desc_3               : 'Naviger til testnet-wallet.kowala.io sin "Vis lommebok-info"-side. ',
...
HELP_4_Desc_2               : 'Naviger til "Send kUSD & Tokens"-siden. ',
...
HELP_4CX_Title              : '4) Hvordan sender jeg ether med MyKowalaWallet CX (Chrome-utvidelsen)? ',
HELP_4CX_Desc_1             : 'Først må du legge til en lommebok. Når du har gjort det, har du 2 muligheter: den kjappe "Send"-funksjonaliteten fra Chrome-utvidelsesikonet eller "Send kUSD & Tokens"-siden. ',
...
HELP_4CX_Desc_12            : 'Bruk "Send kUSD & Tokens"-siden ',

HELP_5_Title                : '5) Hvordan kan jeg bruke testnet-wallet.kowala.io offline/lokalt? ',
HELP_5_Desc_1               : 'Du kan bruke testnet-wallet.kowala.io på datamaskinen din i stedet for fra GitHub-serverne. Du kan opprette en lommebok fullstendig frakoblet fra internett, og sende transaksjoner fra "Send offline"-siden. ',
HELP_5_Desc_7               : 'testnet-wallet.kowala.io kjører nå utelukkende på din datamaskin. ',
HELP_5_Desc_8               : 'I tilfelle du ikke er så vant med dette: du må beholde hele mappen for å kunne kjøre nettsiden, ikke bare `index.html`. Ikke rør eller flytt rundt på noe i mappen. Hvis du lagrer en backup av MyKowalaWallet-repoet for framtiden, anbefaler vi å kun lagre zip-fila så du kan være sikker på at innholdet i mappen forblir intakt. ',
HELP_5_Desc_9               : 'Siden vi oppdaterer testnet-wallet.kowala.io hele tiden, anbefaler vi at du oppdaterer din lagrede versjon av repoet jevnlig. ',
...
HELP_7_Desc_1               : 'Naviger til "Send kUSD & Tokens"-siden. ',
...
HELP_8_Desc_1               : 'MyKowalaWallet er ikke en nett-lommebok (web wallet). Du har ingen innlogging og ingenting blir noensinne lagret på våre servere. Det er ganske enkelt et grensesnitt som tillater deg å samhandle med blokkjeden. ',
HELP_8_Desc_2               : 'Hvis testnet-wallet.kowala.io går ned, må du finne en annen måte (som f.eks. geth eller Ethereum Wallet / Mist) å gjøre det på. Men du vil ikke trenge å "hente" eteren din ut av MyKowalaWallet, fordi den ikke befinner seg i MyKowalaWallet. Den befinner seg i den lommeboka/kontoen som du opprettet ved hjelp av nettsiden vår. ',
...
HELP_8_Desc_4               : 'I tillegg er sannsynligheten for at vi tar ned MyKowalaWallet svært liten. Det koster oss nesten ingenting å opprettholde den siden vi ikke lagrer noen informasjon. Hvis vi tar ned domenet, er det fortsatt, og vil alltid være, offentlig tilgjengelig på [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Du kan laste ned zip-fila der og kjøre den lokalt. ',

HELP_8CX_Title              : '8) Hva skjer hvis MyKowalaWallet CX (Chrome-utvidelsen) forsvinner? ',
...
HELP_8CX_Desc_2             : 'Når det er sagt, så er det **svært viktig** at du sikkerhetskopierer all din informasjon for alle lommebøkene som du har opprettet med MyKowalaWallet CX. På den måten vil du fortsatt ha all nødvendig informasjon for å få tilgang til eteren din selv om noe skulle hende med MyKowalaWallet CX eller datamaskinen din. Se spørsmål #2a ang. hvordan du sikkerhetskopierer lommebøkene dine. ',
HELP_8CX_Desc_3             : 'Hvis MyKowalaWallet CX av en eller annen grunn skulle forsvinne fra Chrome Store, så kan du finne kildekoden på Github og laste den inn manuelt. Se #5 ovenfor. ',

HELP_9_Title                : '9) Er "Send kUSD & Tokens"-siden offline? ',
...
HELP_10_Desc_11             : 'Lim inn den signerte transaksjonen i tekstfeltet i steg #3 på den tilkoblede maskinen og klikk "Send kUSD & Tokens". Dette vil kringkaste transaksjonen din. ',

HELP_12_Title               : '12) Hvordan kan jeg importere en lommebok opprettet med MyKowalaWallet til geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Ved å bruke en Geth/Mist JSON-fil fra MyKowalaWallet v2+.... ',
...
HELP_13_Desc_1              : 'Dette betyr at du ikke har nok kUSD på kontoen din til å dekke gas-kostnaden. Hver transaksjon (inkludert token- og kontrakt-transaksjoner) krever gas, og gas betales med kUSD. Tallet som vises er beløpet som kreves for å dekke transaksjonskostnaden i Wei (1 kUSD = 10^18 Wei). Ta dette tallet, del det på `1000000000000000000`, og trekk fra kUSD-beløpet som du prøvde å sende (hvis du prøvde å sende kUSD). Dette vil gi deg kUSD-beløpet som du mangler på (trenger å sende til) denne kontoen for å gjennomføre transaksjonen. ',

HELP_14_Title               : '14) Noen nettsider randomiserer genereringen av den private nøkkelen via musebevegelser. testnet-wallet.kowala.io gjør ikke dette. Er metoden som MyKowalaWallet bruker til å generere tilfeldige tall sikker? ',
HELP_14_Desc_1              : 'Selv om musebevegelses-metoden er smart og vi skjønner hvorfor folk liker den, så er realiteten at window.crypto sikrer mer entropi (tilfeldighet) enn musebevegelser. Musebevegelses-metoden er ikke usikker, men det er bare det at vi (og mange andre kryptoeksperter) har tro på window.crypto. I tillegg kan testnet-wallet.kowala.io også benyttes på fingerstyrte enheter. Her er en [konversasjon mellom en sint redditor og Vitalik Buterin angående musebevegelser versus window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) og her er [window.crypto w3 spesifikasjonen](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_15_Desc_1              : 'Kontoer vil kun dukke opp i en blokkjede-utforsker når kontoen har hatt aktivitet&mdash;for eksempel, når du har overført kUSD til den. ',
...
HELP_21_Title               : '21) Kan ikke hvem som helst legge inn tilfeldige private nøkler, sjekke saldoen, og sende kUSD til sin egen adresse? ',
HELP_21_Desc_1              : 'Kortversjonen: ja, men å finne en konto som inneholder kUSD ville tatt lengre tid enn universets levealder...så...nei. ',
...
HELP_SecCX_Title            : 'Datasikkerhet - MyKowalaWallet CX (Chrome-utvidelsen) ',
...
HELP_SecCX_Desc_6           : 'Hvis vi skulle kryptere disse, måtte du ha oppgitt et passord hver gang du ønsket å se saldo for kontoene dine eller vise kallenavnene. Hvis dette bekymrer deg, anbefaler vi deg å bruke testnet-wallet.kowala.io i stedet for denne Chrome-utvidelsen. ',
...
HELP_Sec_Desc_3             : 'Vi kommer ikke til å ta pengene dine eller stjele dine private nøkler. Det er ingen ondsinnet kode på denne siden. Faktisk er "Send kUSD & Tokens"-siden fullstendig klient-drevet. Det betyr at all koden blir kjørt på ** din datamaskin ** og det blir aldri lagret eller overført noe sted. ',
HELP_Sec_Desc_4             : 'Sjekk nettsideadressen (URL) -- Denne siden blir drevet gjennom GitHub og du kan se kildekoden her: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) til domenet: [https://testnet-wallet.kowala.io](https://testnet-wallet.kowala.io). ',
