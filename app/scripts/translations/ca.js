...
tx_notFound_4               : 'Utilitza el menú desplegable a la part superior dreta i selecciona un node kUSD diferent (p. Ex. `kUSD (Etherscan.io)` o `kUSD (Infura.io)` o `kUSD (MyKowalaWallet)`)  i torna-ho a comprovar.',
...
tx_FoundOnChain_3           : '**Si no veus cap error, la teva transacció s\'ha enviat amb èxit.** El teu kUSD o Tokens són on els has enviat. Si no pots veure aquest kUSD o Tokens a la teva cartera / compte de bescanvi, i han passat més de 24 hores des de l\'enviament, si us plau [contacta amb aquest servei](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Envia *l\'enllaç* de la teva transacció si demana amablement que investiguin.',
...
GEN_Help_12                 : 'Utilitza\'l per desbloquejar la teva cartera amb MyKowalaWallet (o Mist, Geth, Parity i altres clients de carteres.) ',
...
GAS_LIMIT_Desc              : 'El límit de gas és la quantitat de gas a enviar amb la teva TX. `TX fee` = preu del gas * límit de gas; i es paga als miners per incloure la teva TX a un block. Incrementat aquest nombre no farà que la teva TX sigui minada més ràpidament. Enviant kUSD = `21000`. Enviant Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'La comissió per la TX es paga als miners per incloure la teva TX en un block. És el `límit de gas` * `preu del gas`. [Pots convertir GWEI -> kUSD aquí](https://testnet-wallet.kowala.io/helpers.html)',
...
NAV_SendEther               : 'Envia kUSD & Tokens ',
...
/* General */
x_Access                    : 'Accedir ',
x_AddessDesc                : 'La teva adreça també pot ser anomenada `# de compte` o `Clau Pública`. És el que comparteixes amb la gent perquè puguin enviar-te kUSD o Tokens. Cerqueu la icona d\'adreça de colors. Assegura\'t que coincideixi amb la vostra cartera de paper i quan introduïu la vostra adreça en algun lloc.',
x_Address                   : 'La teva adreça ',
x_Cancel                    : 'Cancel·lar ',
x_CSV                       : 'Fitxer CSV (no xifrat) ',
x_Download                  : 'Descarregar ',
x_Json                      : 'Fitxer JSON(no xifrat) ',
x_JsonDesc                  : 'Aquesta és la teva clau privada no xifrada, en format JSON. Això significa que no necessites la contrasenya, però qualsevol que trobi el JSON pot accedir a la teva cartera i kUSD sense la contrasenya. ',
...
/* Header */
CX_Tagline                  : 'Cartera d\'kUSD de codi obert programada amb JavaScript executada en el client com a extensió de Chrome ',
...
MEW_Tagline                 : 'Cartera d\'kUSD de codi obert programada amb JavaScript ',
...
sidebar_donation            : 'MyKowalaWallet és un servei lliure i de codi obert, dedicat a la teva privacitat i seguretat. Com més donacions rebem, més temps invertim creant noves funcions, escoltant els vostres comentaris i oferint-vos el que voleu. Només som dues persones que intentem canviar el món. Ens ajudes? ',
sidebar_donate              : 'Dóna ',
...
ADD_Ledger_0a               : 'Has d\'accedir a MyKowalaWallet utilitzant una connexió segura (SSL / HTTPS). ',
ADD_Ledger_0b               : 'Torna a obrir MyKowalaWallet utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Torna a obrir MyKowalaWallet utilitzant una connexió segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Torna a obrir MyKowalaWallet utilitzant [Chrome](https://www.google.com/chrome/browser/desktop/) o [Opera](https://www.opera.com/) ',
...
ADD_Warning_1               : 'Pots afegir qualsevol compte per "supervisar" a la pestanya de carteres sense pujar una clau privada. Això ** no ** vol dir que tinguis accés a aquesta cartera ni que puguis transferir-ne l\'kUSD d\'aquesta. ',
...
MYWAL_Content_3             : 'Si vols utilitzar aquesta cartera amb MyKowalaWallet CX en el futur, hauràs de tornar a afegir-la manualment utilitzant la clau privada/JSON i contrasenya. ',
...
TRANS_sendInfo              : 'Una transacció estàndard utilitzant 21000 gas costarà 0.000441 kUSD. Utilitzem un preu una mica per sobre del mínim de 0.000000021 kUSD per assegurar que es mina ràpidament. No ens quedem cap comissió per la transacció. ',
...
NODE_Warning                : 'El teu node ha de ser HTTPS per tal de poder-t\'hi connectar utilitzant testnet-wallet.kowala.io. Pots [descarregar-te el repo de MyKowalaWallet i executar-lo localment](https://github.com/kvhnuke/etherwallet/releases/latest) per connectar-te a qualsevol node. O, obtén un certificat SSSL gratuït amb [LetsEncrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " per ", // "I want to swap my X kUSD for X BTC"
...
SWAP_progress_3             : "Rebut! ", // kUSD Received!
SWAP_progress_4             : "Enviant el teu {{orderResult.output.currency}} ",
SWAP_progress_5             : "Comanda completa ",
SWAP_order_CTA              : "Si us plau envia ", // Please send 1 kUSD...
SWAP_unlock                 : "Desbloqueja la teva cartera per enviar kUSD o Tokens directament des d\'aquesta pàgina ",
...
HELP_4_Desc_2               : 'Navigate to the "Send kUSD & Tokens" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send kUSD & Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Send kUSD & Tokens" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Send kUSD & Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Send kUSD & Tokens" page offline? ',
