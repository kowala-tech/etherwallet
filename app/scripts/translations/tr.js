...
NAV_SendEther               : 'kUSD ve Tokens gönder ',
...
MEW_Tagline                 : 'Acik kaynak JavaScript Client-Side kUSD cüzdani ',
CX_Tagline                  : 'Acik kaynak JavaScript Client-Side kUSD cüzdani Chrome Extension ',

/* Footer */
FOOTER_1                    : 'Acik kaynak, javascript Client-Side Ethererum cüzdani ve kUSD islemleri ',
...
sidebar_donation            : 'MyKowalaWallet gizlilik ve güvenlike adanmış ücretsiz ve açık kaynak kodlu bir hizmettir. Ne kadar cok bagis edilirse o kadar cok yeni özellik programlamaya, görüşlerinizi işlemeye yatitim yapabiliriz. Biz sadece dünyayı değiştirmek isteyen iki kişiyiz. Bize yardım edermisin? ',
...
ADD_Warning_1               : 'Özel anahtar yazmadan cüzdan sekmesinde "izlemek" için herhangi bir hesap ekleyebilirsin. Bu demek ** degilki ** cüzdani acabilirsin, veya ondan kUSD aktarabilirsin. ',
...
TRANS_warning               : '"Yalnızca kUSD" ya da "Yalnızca ETC" fonksiyonu kullanıyorsan, bir sözleşme yoluyla gönderiyorsun. Bazı servisler bu işlemleri kabul etmekde sorunları var. Daha fazla oku. ',
TRANS_advanced              : '+Gelişmiş: Veri ekle ',
TRANS_data                  : 'Veri ',
TRANS_gas                   : 'Gas Limiti ',
TRANS_sendInfo              : '21000 gaz kullanan standart bir islem 0.000441 kUSD ile mal olur. Biz hizli bir sekilde mayinlanmasi için, 0.000000021 kUSD\'dan biraz daha yüksek gaz fiyatini kullaniyoruz. Biz herhangi bir islem ücreti almiyoruz. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Yalnızca kUSD" and "Yalnızca ETC" islemler ',
TRANSModal_Content_0        : 'Farklı işlemler ve farklı hizmetleri hakkında bir not: ',
TRANSModal_Content_1        : '**kUSD (Standart islem): ** Bu standart bir islem baslatir bir hesapten direkt baska bir hesapa. Standart gas 21000\'dir. Bu islemlen gönderileren islem ETC zincirinde\'de yer bulabilir. ',
TRANSModal_Content_2        : '**Only kUSD: ** This sends via [Timon Rapp\'s replay protection contract (as recommended by VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) so that you only send on the **kUSD** chain. ',
...
MYWAL_Content_3             : 'If you want to use this wallet with your MyKowalaWallet CX in the future, you will need to manually re-add it using the private key/JSON and password. ',
...
ERROR_17                    : 'Account you are sending from does not have enough funds. If sending tokens, you must have 0.01 kUSD in your account to cover the cost of gas. ', // 17
...
ERROR_28                    : 'Ilerde cüzdanini acmak icin **Keystore dosyan ve parolan veya özel anahtarin** lazim olacak. Lütfen kaydet ve dista yedekle! Kaydedilmemiş cüzdanini kurtarmanin hiçbir yolu yoktur. Talimatlar icin yardim [help page](https://testnet-wallet.kowala.io/#help) sayfasini oku ',
...
TranslatorName_1            : '[ffidan61](https://testnet-wallet.kowala.io/?gaslimit=21000&to=0xF1Fdf8635cc35a084B97905F62a021cAd71fbC21&value=1.0#send-transaction) ',
...
HELP_4_Desc_2               : 'Navigate to the "kUSD ve Tokens göndermek" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send kUSD" page. ',
...
HELP_4CX_Desc_12            : 'Using "Send kUSD" Page ',

HELP_5_Title                : '5) How do I run testnet-wallet.kowala.io offline/locally? ',
HELP_5_Desc_1               : 'You can run testnet-wallet.kowala.io on your computer instead of from the GitHub servers. You can generatea a wallet completely offline and send transactions from the "Offline Transaction" page. ',
...
HELP_7_Desc_1               : 'Navigate to the "kUSD ve Tokens göndermeks" page. ',
...
HELP_9_Title                : '9) Is the "Send kUSD" page offline? ',
...
HELP_10_Desc_11             : 'On your online computer, paste the signed transaction into the text field in step #3 and click "SEND kUSD". This will broadcast your transaction. ',
...
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experments) believe in window.crypto. In addition, testnet-wallet.kowala.io can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Güvenlik - MyKowalaWallet CX ',
