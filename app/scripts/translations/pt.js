...
X_HelpfulLinks_4                :  'Migrando para/de MyKowalaWallet',
...
NAV_SendEther               : 'Enviar kUSD & Tokens ',
...
MEW_Tagline                 : 'Fonte aberta JavaScript para o client-side da Carteira kUSD ',
CX_Tagline                  : 'Fonte Aberta JavaScript para o client-side da Carteira kUSD para extensão do Chrome ',
...
sidebar_donation            : 'MyKowalaWallet é grátis, um serviço de fonte aberta dedicado a sua privacidade e segurança. Quanto mais doações nós recebermos, mais podemos gastar criando novidade, ouvindo seu feedback, e entregando o que você deseja. Somos apenas duas pessoas tentando mudar o mundo. Ajude-nos? ',
sidebar_donate              : 'De ',
...
ADD_Warning_1               : 'Você pode adicionar qualquer conta para "ver" na tab de carteiras sem fazer o upload da chave privada. Isso significa que você ** não **  tem acesso a essa carteira, nem pode transferir kUSD a partir dela. ',
...
/* Send Transaction */
TRANS_desc                  : '',
TRANS_warning               : 'Se você estiver usando somente "kUSD" ou "ETC" Funções que você está enviando através de um contrato. Alguns serviços têm problemas para aceitar essas transações. Leia mais. ',
TRANS_advanced              : '+Avançado: Adicionar dados ',
TRANS_data                  : 'Dados ',
TRANS_gas                   : 'Gás Limit ',
TRANS_sendInfo              : 'Uma transação padrão usando 21000 gás irá custar 0.000441 kUSD. Nós usamos um preço ligeiramente acima do mínima de gás de 0,000000021 kUSD para garantir que ele seja minado rapidamente. Nós não recebemos nenhuma taxa de transação. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Só kUSD" e "Só ETC" Transações ',
TRANSModal_Content_0        : 'Uma nota sobre diferentes transações e diferentes serviços: ',
TRANSModal_Content_1        : '**kUSD (Transação Padrão): ** Isso gera uma transação padrão diretamente de um endereço para outro. Tem um gás padrão de 21000. É provável que qualquer kUSD enviados através deste método serão repetidos para a cadeia ETC.. ',
TRANSModal_Content_2        : '**Só kUSD: ** Isso envia via [Timon Rapp\'s contrato de proteção de repetição (como recomendado pelo VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) para que você só envie na cadeia **kUSD**. ',
...
MYWAL_Content_3             : 'Se pretender utilizar esta carteira com o MyKowalaWallet CX no futuro, terá de voltar a adicioná-la manualmente utilizando a chave privada/JSON e a palavra-passe. ',
...
ADD_Ledger_0a               : 'Re-abra MyKowalaWallet em uma conexão (SSL) segura ',
ADD_Ledger_0b               : 'Re-abra MyKowalaWallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Re-abra MyKowalaWallet em uma conexão (SSL) segura ',
ADD_DigitalBitbox_0b        : 'Re-abra MyKowalaWallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/) ',
...
ERROR_28                    : '**Você precisa do seu arquivo de armazenamento de chaves & senha** (ou Chave Privada) para acessar essa carteira no futuro. Por favor, salve e armazene ela externamente! Não há como recuperar uma carteira se você não salvar isso. Leia a [página de ajuda](https://testnet-wallet.kowala.io/#help) para instruções. ',
...
TranslatorName_1            : '[ Pedro "ShooterXD" Vieira ](https://testnet-wallet.kowala.io/?gaslimit=21000&to=0x24eB7d82166361A8B69adE6FEA187Cb00FD7c7E1&value=1.0#send-transaction) ',
TranslatorAddr_1            : '',
...
HELP_4_Desc_2               : 'Navigate to the "Enviar kUSD & Tokens" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Enviar kUSD & Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Enviar kUSD & Tokens" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Enviar kUSD & Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Enviar kUSD & Tokens" page offline? ',
