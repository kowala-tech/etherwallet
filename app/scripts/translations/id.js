...
X_HelpfulLinks_4                :  'Migrasi ke/dari MyKowalaWallet',
...
ENS_Helper_4                    :  'Tentukan jumlah maksimum kUSD yang bersedia Anda bayar untuk nama tersebut (<u>Bid Amount</u> Anda). Pastikan akun memiliki cukup dana untuk membayar tawaran Anda + 0.01 kUSD untuk gas.',
...
ENS_Helper_16                   :  'Pemenang akan mendapat pengembalian selisih antara tawaran mereka dan tawaran tertinggi berikutnya. Jika Anda adalah satu-satunya penawar, akan mendapat pengembalian penuh dipotong 0,01 kUSD.',
...
EOS_06                          :  'Buka halaman Send kUSD & Tokens',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Selamat datang di testnet-wallet.kowala.io',
...
ONBOARD_welcome_content__5      :  'MyKowalaWallet adalah antarmuka sisi klien berbasis open source yang gratis.',
...
ONBOARD_bank_title              :  'MyKowalaWallet bukan Bank',
...
ONBOARD_interface_title         :  'MyKowalaWallet adalah sebuah antarmuka',
ONBOARD_interface_content__1    :  'Saat membuat akun di MyKowalaWallet, Anda menghasilkan kumpulan nomor kriptografi: Kunci Privat dan kunci publik (alamat) Anda.',
...
ONBOARD_interface_content__6    :  'Jika Anda mengirim *kunci publik (alamat)* kepada seseorang, mereka dapat mengirimkan kUSD atau token. 👍',
...
ONBOARD_blockchain_content__4   :  'Blok di blockchain berisi catatan dari semua transaksi individual yang dikirim dari MyKowalaWallet, MetaMask, Exodus, Mist, Geth, Parity, dan lain-lainnya..',
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di testnet-wallet.kowala.io atau melihat transaksi Anda di [etherscan.io](https://etherscan.io), Anda melihat data di blockchain, bukan di sistem privat Anda.',
...
ONBOARD_whymew_title            :  'Jika MyKowalaWallet tidak dapat melakukan semua hal tersebut, lalu apa gunanya?',
...
ONBOARD_secure_1_content__1     :  'Phisher biasanya mengirim Anda pesan dengan link ke situs web yang sekilas terlihat seperti MyKowalaWallet, EtherDelta, Paypal, atau bank Anda, namun bukan situs web yang asli. Mereka mencuri informasi Anda dan kemudian mencuri uang Anda.',
ONBOARD_secure_1_content__2     :  'Pasang [EAL](https://chrome.google.com/webstore/detail/etheraddresslookup/pdknmigbbbhmllnmgdfalmedcmcefdfn) atau [MetaMask](https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn) atau [Cryptonite by Metacert](https://chrome.google.com/webstore/detail/cryptonite-by-metacert/keghdcpemohlojlglbiegihkljkgnige) atau [MyKowalaWallet Chrome Extension](https://chrome.google.com/webstore/detail/myetherwallet-cx/nlbmnnijcnlegkjjpcfjclmcfggfefdm) untuk memblokir situs web jahat.',
ONBOARD_secure_1_content__3     :  'Selalu periksa URLnya: `https://testnet-wallet.kowala.io`.',
...
tx_notFound_4               : 'Gunakan dropdown di kanan atas & pilih node kUSD lainnya (e.g. `kUSD (Etherscan.io)` atau `kUSD (Infura.io)` atau `kUSD (MyKowalaWallet)`) dan check kembali.',
...
GEN_Help_12                 : 'Pakailah untuk membuka dompet Anda melalui MyKowalaWallet (atau Mist, Geth, Parity maupun perangkat lunak dompet lainnya.) ',
...
GAS_LIMIT_Desc              : 'Batas Gas (Gas limit) adalah jumlah gas untuk dikirim bersama TX Anda.  `Biaya TX = harga gas * gas limit` & dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Menaikkan angka ini tidak mempercepat TX Anda untuk ditambang. Pengiriman kUSD = `21000`. Pengiriman Token = ~`200000`.',
...
TXFEE_Desc                  : 'Biaya TX Fee dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Jumlahnya =  `gas limit` * `gas price`. [Anda dapat mengkonversi GWEI -> kUSD](https://testnet-wallet.kowala.io/helpers.html)',
...
NAV_SendEther               : 'Kirim kUSD dan Token ',
...
/* General */
x_Access                    : 'Akses ',
x_AddessDesc                : 'Address Anda dikenal juga sebagai `Account #` atau `Public Key` Anda. Address inilah yang diberikan kepada pihak lain agar mereka bisa mengirim kUSD atau Token. Pilihlah icon alamat berwarna untuk memudahkan identifikasi. Pastikan Address ini sama persis dengan yang tertulis di Dompet Kertas Anda maupun saat dipakai untuk keperluan lainnya. ',
x_Address                   : 'Alamat Anda ',
x_Cancel                    : 'Batal ',
x_CSV                       : 'File CSV (tidak ter-enkripsi) ',
x_Download                  : 'Unduh ',
x_Json                      : 'File JSON (tidak ter-enkripsi) ',
x_JsonDesc                  : 'Ini adalah Kunci Privat Anda dalam format JSON yang tidak ter-enkripsi. Tidak diperlukan password dan siapapun yang memiliki JSON Anda dapat mengakses dompet dan kUSD Anda tanpa password. ',
...
ADD_Warning_1               : 'Akun untuk "dilihat" dapat ditambahkan tanpa menggunakan Kunci Privat. Namun berarti tidak ada akses ke dompet tersebut dan transfer kUSD tidak bisa dilakukan. ',
...
ADD_Ledger_0a               : 'Buka kembali MyKowalaWallet melalui koneksi (SSL) yang aman ',
ADD_Ledger_0b               : 'Buka kembali MyKowalaWallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Buka kembali MyKowalaWallet melalui koneksi (SSL) yang aman ',
ADD_DigitalBitbox_0b        : 'Buka kembali MyKowalaWallet menggunakan [Chrome](https://www.google.com/chrome/browser/desktop/) atau [Opera](https://www.opera.com/) ',
...
SENDModal_Content_4         : 'CATATAN: Jika terjadi Error, kemungkinan Anda harus menambah kUSD ke akun Anda untuk menutup biaya gas dan pengiriman. Gas dibayar dalam kUSD. ',
...
TRANS_warning               : 'Penggunaan fitur "Hanya kUSD" atau "Hanya ETC" memakai pengiriman melalui Kontrak. Beberapa layanan tidak menerima transaksi jenis ini. Baca lebih lanjut. ',
TRANS_advanced              : '+Advanced: Tambah Data ',
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'Transaksi standar menggunakan 21000 gas membutuhkan 0.000441 kUSD. Kami memakai harga gas sedikit-diatas-harga-gas-minimum senilai 0.000000021 kUSD untuk mempercepat. Kami tidak mengambil biaya atas transaksi. ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Transaksi "Hanya kUSD" dan "Hanya ETC" ',
TRANSModal_Content_0        : 'Catatan terkait jenis transaksi dan layanan: ',
TRANSModal_Content_1        : '**kUSD (Transaksi Standar): ** Transaksi default ini melakukan pengiriman langsung dari alamat pengirim ke alamat tujuan. Nilai Gas 21000. Besar kemungkinan kUSD yang dikirim dengan metode ini akan di "replay" di rantai ETC. ',
TRANSModal_Content_2        : '**Hanya kUSD: ** Pengiriman melalui [kontrak penangkal "replay" oleh Timon Rapp (direkomendasikan oleh VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) sehingga hanya dilaksanakan di rantai **kUSD** saja. ',
...
TRANSModal_Content_4        : '**Coinbase & ShapeShift: ** Hanya melakukan pengiriman melalui Transaksi Standar saja. Jika Anda mengirim menggunakan "Hanya kUSD" atau "Hanya ETC", hubungi layanan konsumen mereka untuk menambahkan saldo Anda secara manual atau membatalkan transaksinya. [Bisa juga dicoba fasilitas "split" dari Shapeshift.](https://split.shapeshift.io/) ',
...
MYWAL_Content_3             : 'Jika Anda akan memakai dompet ini dengan MyKowalaWallet CX Anda ke depan, Kunci Privat/JSON dan password harus ditambahkan lagi secara manual. ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui testnet-wallet.kowala.io. Anda dapat [mengunduh MyKowalaWallet repo & menjalankannya secara lokal](https://github.com/kvhnuke/etherwallet/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
SWAP_init_2                 : " menjadi ", // "I want to swap my X kUSD for X BTC"
...
SWAP_progress_3             : "Diterima! ", // kUSD Received!
SWAP_progress_4             : "Mengirim {{orderResult.output.currency}} ",
SWAP_progress_5             : "Perintah Selesai ",
SWAP_order_CTA              : "Kirimkan ", // Please send 1 kUSD...
SWAP_unlock                 : "Unlock wallet Anda untuk mengirim kUSD atau Token langsung dari halaman ini. ",
...
ERROR_17                    : 'Dana tidak mencukupi. Akun yang dipakai untuk mengirim tidak memiliki dana yang cukup. Minimal harus ada **0.01 kUSD** di akun untuk menutup biaya gas. Tambahkan ether dan coba lagi. ',
...
ERROR_28                    : '**DIPERLUKAN File Keystore & password** (atau Kunci Privat) untuk mengakses dompet Anda. Simpan dan backup dengan baik file ini! Tidak ada mekanisme untuk me-recover dompet jika file-nya hilang. Baca instruksi lengkapnya [di sini](https://testnet-wallet.kowala.io/#help). ',
...
TranslatorName_1            : '[Yos Ginting](https://testnet-wallet.kowala.io/?gaslimit=21000&to=0x8F646C5c215be6E0163f02Bd2eB97AFC2DF70e5c&value=1.0#send-transaction) ',
...
HELP_Remind_Desc_1          : '** Ethereum, testnet-wallet.kowala.io & MyKowalaWallet CX, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan kUSD Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas kUSD yang hilang**. ',
HELP_Remind_Desc_2          : 'testnet-wallet.kowala.io & MyKowalaWallet CX bukan "dompet web". Anda tidak membuat akun atau memberikan kUSD Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_0_Desc_1               : 'MyKowalaWallet memberi Anda kemampuan untuk membuat dompet baru sehingga Anda dapat menyimpan kUSD oleh diri Anda sendiri, bukan di bursa. Proses ini dilakukan sepenuhnya di komputer Anda, bukan di server kami. Oleh karena itu, saat Anda membuat dompet baru, **Anda bertanggung jawab untuk menyimpan cadangan/backup-nya dengan aman**. ',
...
HELP_0_Desc_5               : 'Transfer kUSD ke dompet baru ini. ',
...
HELP_2a_Desc_2              : 'Simpan alamatnya. Anda bisa menyimpannya untuk diri sendiri atau membaginya dengan orang lain. Dengan cara itu, orang lain bisa mentransfer kUSD ke Anda. ',
HELP_2a_Desc_3              : 'Simpan untuk diri sendiri semua versi Kunci Privat. Jangan berbagi dengan orang lain. Kunci Privat tersebut akan Anda diperlukan saat Anda ingin mengakses kUSD Anda untuk mengirimkannya! Ada 3 jenis Kunci Privat: ',
...
HELP_2b_Title               : '2b) Bagaimana cara penyimpanan yang aman / offline / cold storage menggunakan MyKowalaWallet? ',
...
HELP_3_Desc_1               : '**Sebelum Anda mengirim kUSD ke dompet baru Anda**, Anda harus memastikan Anda memiliki akses ke dompet baru tersebut. ',
HELP_3_Desc_2               : 'Buka halaman "Lihat Info Dompet". ',
HELP_3_Desc_3               : 'Buka laman testnet-wallet.kowala.io bagian "Lihat Info Dompet" . ',
...
HELP_4_Title                : '4) Bagaimana cara mengirim kUSD dari satu dompet ke dompet lainnya? ',
...
HELP_4_Desc_2               : 'Buka halaman "Kirim kUSD dan Token". ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim kUSD menggunakan MyKowalaWallet CX? ',
HELP_4CX_Desc_1             : 'Pertama, Anda perlu menambahkan dompet. Setelah melakukannya, Anda memiliki 2 pilihan: menggunakan "QuickSend" dari ikon Chrome Extension atau menggunakan halaman "Kirim kUSD dan Tokens". ',
...
HELP_4CX_Desc_12            : 'Menggunakan halaman "Kirim kUSD dan Tokens" ',

HELP_5_Title                : '5) Bagaimana cara menjalankan testnet-wallet.kowala.io secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan testnet-wallet.kowala.io secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'testnet-wallet.kowala.io sekarang berjalan sepenuhnya di komputer Anda. ',
HELP_5_Desc_8               : 'Jika Anda belum pernah melakukannya, Anda harus menyimpan folder dan seluruh isinya (bukan hanya `index.html`) agar bisa menjalankan websitenya. Jangan rubah atau pindahkan file apapun yang ada di dalam folder. Jika Anda akan menyimpan backup dari MyKowalaWallet repo, sebaiknya simpan versi ZIP-nya untuk menggaransi bahwa isi foldernya lengkap. ',
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui testnet-wallet.kowala.io, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_1               : 'MyKowalaWallet bukan dompet web. Anda tidak memiliki login dan tidak ada yang bisa disimpan ke server kami. Ini hanyalah sebuah antarmuka yang memungkinkan Anda berinteraksi dengan blockchain. ',
HELP_8_Desc_2               : 'Jika situs testnet-wallet.kowala.io tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" kUSD Anda dari testnet-wallet.kowala.io karena kUSD Anda tidak disimpan di testnet-wallet.kowala.io. kUSD Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_8CX_Desc_2             : 'terlepas dari semua itu, **sangat penting** bagi Anda untuk membuat backup/cadangan dari semua informasi dompet baru yang Anda buat dengan MyKowalaWallet CX. Dengan begitu, jika terjadi sesuatu pada MyKowalaWallet CX atau komputer Anda, Anda masih memiliki semua informasi yang diperlukan untuk mengakses kUSD Anda. Lihat #2a untuk cara membuat backup/cadangan dompet Anda. ',
HELP_8CX_Desc_3             : 'Jika karena suatu hal maupun lainnya MyKowalaWallet CX tidak lagi tersedia di Chrome Store, Anda tetap dapat menemukan file aslinya di Github dan menjalankannya secara manual. Lihat #5 di atas. ',

HELP_9_Title                : '9) Kenapa halaman "Kirim kUSD dan Tokens" seperti offline? ',
...
HELP_12_Title               : '12) Bagaimana cara mengimpor dompet yang dibuat dengan MyKowalaWallet ke dalam geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Memakai file Geth/Mist JSON yang dibuat dari MyKowalaWallet v2+.... ',
...
HELP_SecCX_Title            : 'Keamanan - MyKowalaWallet CX ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan testnet-wallet.kowala.io, bukan Chrome Extension ini. ',
...
HELP_Sec_Desc_4             : 'Periksa URL ini -- Situs ini dijalankan melalui GitHub dan Anda bisa melihat sorce code nya di sini: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) ke [https://testnet-wallet.kowala.io](https://testnet-wallet.kowala.io). ',
