...
X_HelpfulLinks_4                :  'Migrating to/from MyKowalaWallet',
...
ENS_Finalize_content            :  'Finalizing this name assigns the ENS name to the winning bidder. The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.01 kUSD. Any non-winners will also be refunded.',
...
ENS_Helper_4                    :  'Decide the maximum amount of kUSD you are willing to pay for the name (your <u>Bid Amount</u>). Ensure that account has enough to cover your bid + 0.01 kUSD for gas.',
...
ENS_Helper_16                   :  'The winner will be refunded the difference between their bid and the next-highest bid. If you are the only bidder, you will refunded all but 0.01 kUSD.',
...
EOS_06                          :  'Go to Send kUSD & Tokens Page',
...
/* Onboarding */
ONBOARD_welcome_title           :  'Welcome to testnet-wallet.kowala.io',
...
ONBOARD_welcome_content__5      :  'MyKowalaWallet is a free, open-source, client-side interface.',
...
ONBOARD_bank_title              :  'MyKowalaWallet is not a Bank',
...
ONBOARD_interface_title         :  'MyKowalaWallet is an Interface',
ONBOARD_interface_content__1    :  'When you create an account on MyKowalaWallet you are generating a cryptographic set of numbers: your private key and your public key (address).',
...
ONBOARD_interface_content__6    :  'If you send your *public key (address)* to someone, they can send you kUSD or tokens. 👍',
...
ONBOARD_blockchain_content__4   :  'The blocks in the blockchain are made up of all the individual transactions sent from MyKowalaWallet, MetaMask, Exodus, Mist, Geth, Parity, and everywhere else.',
ONBOARD_blockchain_content__5   :  'When you see your balance on testnet-wallet.kowala.io or view your transactions on [etherscan.io](https://etherscan.io), you are seeing data on the blockchain, not in our personal systems.',
...
ONBOARD_whymew_title            :  'If MyKowalaWallet can\'t do those things, what\'s the point?',
...
ONBOARD_secure_1_content__1     :  'Phishers send you a message with a link to a website that looks just like MyKowalaWallet, EtherDelta, Paypal, or your bank, but is not the real website. They steal your information and then steal your money.',
...
ONBOARD_secure_1_content__3     :  'Always check the URL: `https://testnet-wallet.kowala.io`.',
...
ADD_Ledger_0a: 'با یک کانکشن امن (SSL) دوباره MyKowalaWallet را باز کنید. ',
ADD_Ledger_0b: 'با استفاده از [Chrome](https://www.google.com/chrome/browser/desktop/) یا [Opera](https://www.opera.com/) دوباره MyKowalaWallet را باز کنید. ',
...
MYWAL_Content_3: ',اگر در آینده بخواهید از این کیف پول با استفاده از  MyKowalaWallet CX خود استفاده کنید، باید بصورت دستی دوباره آن را اضافه کنید. این کار با استفاده از key/JASON و رمزعبور انجام می شود.',
...
// "/* full sentence reads ""You are about to send ""10 kUSD"" to address ""0x1234"". Are you sure you want to do this? "" */" : "شما در حال ارسال ""10 اتر"" به آدرس ""0x1234"" هستید. آیا از این کار اطمینان دارید؟ ',
...
TRANS_warning: 'اگر از توابع ""فقط kUSD"" یا ""فقط ETC"" استفاده می کنید، شما در حال ارسال از طریق یک قرارداد هستید. برخی از سرویس ها با قبول چنین تراکنش هایی مشکل دارند. بیشتر ',
...
SWAP_init_2: ' for , // ""I want to swap my X kUSD for X BTC',
SWAP_init_CTA: 'ادامه ',
...
SWAP_progress_3: 'Received! , // kUSD Received!',
SWAP_progress_4: 'Sending your {{orderResult.output.currency}} ,',
SWAP_progress_5: 'Order Complete ,',
SWAP_order_CTA: 'Please send , // Please send 1 kUSD...',
SWAP_unlock: 'Unlock your wallet to send kUSD or Tokens directly from this page. ',
...
ERROR_27                        :  '(error_28) برای دسترسی به این کیف پول در آینده به فایل Keystore و رمزعبور خود (یا کلید خصوصی) نیاز خواهید داشت. لطفا آن را ذخیره کنید و یک نسخه پشتیبان خارجی بسازید. اگر آن را ذخیره نکنید، هیچ راهی برای بازگرداندن کیف پول وجود ندارد. برای راهنمایی [صفحه کمک](https://testnet-wallet.kowala.io/#help)  را مطالعه بفرمایید. Minimum amount: 0.01. Max amount:', // 27
...
HELP_4CX_Title: 'سوال 4: چگونه با کیف پول MyKowalaWallet خود اتر ارسال کنم؟ ',
...
HELP_5_Title: 'سوال 5: چگونه از testnet-wallet.kowala.io بصورت آفلاین استفاده کنم؟ ',
HELP_5_Desc_1: 'شما می توانید testnet-wallet.kowala.io را به جای اجرا از روی سرورهای GitHub، روی کامپیوتر خود اجرا کنید. شما می توانید یک کیف پول را کاملا بصورت آفلاین بسازید و تراکنشی را از طریق صفحه ""تراکنش آفلاین"" ارسال کنید. ',
HELP_5_Desc_7: 'حال testnet-wallet.kowala.io بطور کامل در حال اجرا شدن از روی کامپیوتر شماست. ',
HELP_5_Desc_8: 'در صورتی که با این موضوع آشنایی ندارید بهتر است بدانید که باید تمام پوشه (فولدر) را نگهداری کنید تا بتوانید وبسایت را اجرا کنید (نه فقط index.html را). به چیزی در این پوشه دست نزنید و یا جابجا نکنید. اگر یک نسخه پشتیبان از کد مخزن MyKowalaWallet را برای آینده نگهداری می کنید پیشنهاد می شود که تنها ZIP را نگهداری کنید تا از اینکه تمام محتوای پوشه درست ذخیره می شوند اطمینان حاصل کنید. ',
HELP_5_Desc_9: 'از آنجایی که ما بطور مداوم در حال بروزرسانی testnet-wallet.kowala.io هستیم، پیشنهاد می کنیم که نسخه ذخیره شده خود را بصورت دوره ای بروزرسانی کنید. ',
...
HELP_8_Desc_1: 'وبسایت MyKowalaWallet یک کیف پول وبی نیست. نیازی نیست که وارد شوید (لاگین کنید) و هیچ چیزی بر روی سرورهای ما ذخیره نمی شود. این تنها یک ظاهر است که به شما امکان برقراری ارتباط با بلاکچین را می دهد. ',
HELP_8_Desc_2: 'اگر  testnet-wallet.kowala.io از کار بیافتد، راه دیگری (مثل geth یا Ethereum Wallet/ Mist) وجود دارد که کاری که ما انجام می دهیم را انجام دهد. اما نیازی نیست که اترهای خود را از  MyKowalaWallet بیرون بیاورید چرا که آن ها در  MyKowalaWallet نیستند، بلکه در هر کیف پولی ست که شما از طریق سایت ما ساخته باشید. ',
...
HELP_8CX_Desc_2: 'مهم است در نظر داشته باشید که برای هر کیف پولی که با  MyKowalaWallet CX ساخته می شود، از تمام اطلاعات خود یک نسخه پشتیبان تهیه کنید. در اینصورت اگر هر اتفاقی برای  MyKowalaWallet CX یا کامپیوترتان بیافتد، همچنان اطلاعات لازم جهت دسترسی به اترهای خود را خواهید داشت. به سوال 2 الف برای چگونگی تهیه نسخه پشتیبان از کیف پول مراجعه کنید. ',
HELP_8CX_Desc_3: 'اگر به هر دلیلی  MyKowalaWallet CX از Chrome Store ناپدید شد، می توانید سورس (کد منبع) آن را از Github پیدا کرده و بصورت دستی اجرا کنید. به سوال شماره 5 مراجعه کنید. ',
...
HELP_12_Title: 'سوال 12: چگونه کیف پولی که با MyKowalaWallet ساخته ام را به geth یا Ethereum Wallet یا Mist منتقل کنم؟ ',
HELP_12_Desc_1: ',با استفاده از فایل Geth یا Mist JSON از MyKowalaWallet نسخه 2 به بالا.',
...
HELP_13_Desc_1: 'این بدان معناست که در حساب خود به اندازه کافی اتر (ٍkUSD) جهت پرداخت هزینه سوخت را ندارید. هر تراکنش (که شامل توکن و تراکنش های قراردادی نیز می شود) به سوخت نیاز دارد و این سوخت با اتر پرداخت می شود. عددی که نمایش داده شد، مقداری ست که برای پوشش هزینه تراکنش در Wei مورد نیاز است. آن عدد را بر `1000000000000000000` تقسیم کنید و از مقدار اتری که می خواستید ارسال کنید کم کنید (اگر می خواستید که اتر ارسال کنید). این کار به شما میزان اتری که برای انجام تراکنش باید به آن حساب بفرستید را مشخص می کند. ',

HELP_14_Title: 'سوال 14: برخی از سایت ها ساخت رندوم یا تصادفی کلیدهای خصوصی را بر اساس حرکت موس انجام می دهند. سایت testnet-wallet.kowala.io این کار را انجام نمی دهد. آیا تولید تصادفی اعداد برای MyKowalaWallet امن است؟ ',
HELP_14_Desc_1: 'روش ساخت بر اساس حرکت موس هوشمندانه است و می دانیم که  چرا مردم آن را دوست دارند، اما واقعیت این است که window.crypto ؟؟؟؟؟ بیشتری را نسبت به حرکات موس شما ارائه می کنند. حرکات موس ناامن نیستند اما ما (و بسیاری از آزمایش های کریپتو دیگر) در window.crypto باور بیشتری داریم. بعلاوه اینکه از testnet-wallet.kowala.io می توان در دستگاه های لمسی نیز استفاده کرد. در [اینجا می توانید بحث بین یک نویسنده عصبانی در reddit و Vitalik Buterin درباره حرکات موس و window.crypto را ببینید](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title: 'امنیت - MyKowalaWallet CX ',
...
HELP_SecCX_Desc_6: 'اگر می خواستیم این موارد را رمزنگاری کنیم، هربار که می خواستید موجودی حساب یا نام های اختصاری را ببینید مجبور به وارد کردن رمزعبور می شدید. اگر این موضوع برایتان مهم است، پیشنهاد می کنیم از testnet-wallet.kowala.io به جای این Chrome Extension استفاده کنید. ',
...
HELP_Sec_Desc_4: 'این سایت از طریق GitHub ارائه می شود، می توانید کد اصلی یا Source Code آن را در این آدرس ببینید:  [https://github.com/kvhnuke/etherwallet/tree/gh-](https://github.com/kvhnuke/etherwallet/tree/gh-pages) و [https://testnet-wallet.kowala.io](https://testnet-wallet.kowala.io). ',
