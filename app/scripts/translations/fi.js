...
MEW_Tagline                 : 'Avoimen Lähdekoodin JavaScript kUSD Lompakko ',
...
TRANS_warning               : 'Jos käytät "Vain kUSD" tai "Vain ETC" Toimintoja, niin lähetät sopimuksen kautta. Joillakin palveluilla on vaikeuksia hyväksyä näitä siirtoja. Lue lisää. ',
...
TRANSModal_Title            : '"Vain kUSD" ja "Vain ETC" Siirrot ',
TRANSModal_Content_0        : 'Huomautus erilaisista siirroista ja eri palveluista: ',
TRANSModal_Content_1        : '**kUSD (Tavallinen Siirto): ** Tämä luo oletusarvoisen siirron osoitteesta toiseen. Siinä on oletus gasina 21000. On todennäköistä että kaikki kUSD joka lähetetään tällä tavalla, toistetaan ETC ketjussa. ',
TRANSModal_Content_2        : '**Vain kUSD: ** Tämä lähettää [Timon Rappin toiston suojaus sopimuksen kautta (kuten VB on suositellut)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) niin että sinä lähetät vain **kUSD** ketjussa. ',
...
MYWAL_Content_3             : 'Jos tahdot käyttää tätä lompakkoa MyKowalaWallet CX:si kanssa tulevaisuudessa, sinun täytyy manuaalisesti uudelleen-lisätä se käyttäen yksityistä salausavaintasi/JSONia ja salasanaa. ',
...
TranslatorName_1            : '[Smokyish](https://testnet-wallet.kowala.io/?gaslimit=21000&to=0xac9a2c1dd946da64c0dc8e70cec2cfb14304fd4f&value=1.0#send-transaction)',
TranslatorAddr_1            : '',
