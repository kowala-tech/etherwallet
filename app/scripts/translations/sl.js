...
NAV_SendEther               : 'Pošlji kUSD in Žetone ',
...
MEW_Tagline                 : 'Odprto-kodni JavaScript kUSD Denarnica za splošno uporabo ',
CX_Tagline                  : 'Odprto-kodni JavaScript kUSD Denarnica Chrome Dodatek za splošno uporabo ',

/* Footer */
FOOTER_1                    : 'Odprto-kodni, JavaScript, orodje za generiranje kUSD Denarnic in pošiljanje transakcij za splošno uporabo. ',
...
sidebar_donation            : 'MyKowalaWallet je brezplačna, odprto-kodna, platforma, ki skrbi za vaše privatne informacije in vašo varnost. Več donacij ko dobimo, več časa lahko posvetimo ustvarjanju novih funkcij, ter se lahko bolje posvetimo vašim željam, da tko da vam vedno lahko ponudimo karseda najboljši produkt. MyKowalaWallet je ekipa dveh ljudi, ki se trudi spremeniti svet. Hvaležni bomo vaše pomoči. ',
...
ADD_Warning_1               : 'V zavihek denarnic lahko dodate naslov kateregakoli obstoječega kUSD računa, ki ga želite opazovati brez da vnesete njegov osebni ključ. S tem ** ne ** dobite dostopa do računa ki ga opazujete, in ne morete izplačati Ethra s tega računa. ',
...
/* Send Transaction */
TRANS_desc                  : '',
TRANS_warning               : 'If you are using the "Only kUSD" or "Only ETC" Functions you are sending via a contract. Some services have issues accepting these transactions. Read more. ',
TRANS_advanced              : '+Advanced: Add Data ',
TRANS_data                  : 'Data ',
TRANS_gas                   : 'Gas Limit ',
TRANS_sendInfo              : 'A standard transaction using 21000 gas will cost 0.000441 kUSD. We use a slightly-above-minimum gas price of 0.000000021 kUSD to ensure it gets mined quickly. We do not take a transaction fee. ',

/* Send Transaction Modals */
TRANSModal_Title            : '"Only kUSD" and "Only ETC" Transactions ',
TRANSModal_Content_0        : 'A note about the different transactions and different services: ',
TRANSModal_Content_1        : '**kUSD (Standard Transaction): ** This generates a default transaction directly from one address to another. It has a default gas of 21000. It is likely that any kUSD sent via this method will be replayed onto the ETC chain. ',
...
HELP_4_Desc_2               : 'Navigate to the "Pošlji kUSD in Žetone" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Pošlji kUSD in Žetone" page. ',
...
HELP_4CX_Desc_12            : 'Using "Pošlji kUSD in Žetone" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Pošlji kUSD in Žetone" page. ',
...
HELP_9_Title                : '9) Is the "Pošlji kUSD in Žetone" page offline? ',
