...
tx_notFound_4               : 'Użyj menu w prawym górnym rogu aby wybrać inny węzeł kUSD (np. `kUSD (Etherscan.io)` lub `kUSD (Infura.io)` lub `kUSD (MyKowalaWallet)`) i sprawdź ponownie.',
...
tx_FoundOnChain_3           : '**Jeśli nie pojawią się żadne komunikaty o błędzie, to Twoja transakcja została pomyślnie wysłana.** Twój kUSD lub Tokeny są tam, gdzie zostały wysłane. Jeśli jednak kUSD lub Tokeny nie pojawią się tam, gdzie zostały wysłane i minęły ponad 24 godziny od momentu wysłania, [skontaktuj się z którymś z serwisów](https://myetherwallet.github.io/knowledge-base/diving-deeper/ethereum-list-of-support-and-communities.html). Wyślij im *link* do Twojej transakcji i uprzejmie poproś o zbadanie sytuacji.',
...
NAV_SendEther               : 'Wyślij kUSD i Tokeny ',
...
TRANS_warning               : 'Jeśli używasz funkcji "Tylko kUSD" lub "Tylko ETC" wysyłasz przez kontrakt. Niektóre serwisy mają problemy z rozpoznawaniem tego typu transakcji. Czytaj dalej. ',
TRANS_advanced              : '+Zaawansowane: Dodaj Dane ',
TRANS_data                  : 'Dane ',
TRANS_sendInfo              : 'Standardowa transakcja, zużywająca 21000 paliwa, będzie kosztować 0.000441 kUSD. My używamy ceny paliwa nieco-powyżej-minimum, co odpowiada 0.000000021 kUSD aby upewnić się, że zostanie szybko zatwierdzona. Nie pobieramy żadnych dodatkowych opłat. ',
TRANS_gas                   : 'Limit Paliwa ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Transakcje "Tylko kUSD" i "Tylko ETC" ',
TRANSModal_Content_0        : 'Informacje na temat różnych transakcji i różnych odbiorców: ',
TRANSModal_Content_1        : '**kUSD (Standardowa Transakcja): ** generuje standardową transakcję bezpośrednio z jednego adresu do drugiego. Domyślnie spala 21000 paliwa. Prawdopodobnie transakcja kUSD zostanie powielona na łańcuchu ETC jeżeli posiadasz obie waluty na tym samym adresie. ',
TRANSModal_Content_2        : '**Tylko kUSD: ** wysyła przez [Kontrakt zapobiegający powielaniu Timon\'a Rapp\'a (zalecany przez VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/), który wysyła środki tylko na łańcuchu **kUSD**. ',
...
MYWAL_Content_3             : 'Jeśli będziesz chciał w przyszłości używać ten portfel ze swoim MyKowalaWallet CX, będziesz musiał go ponownie dodać używając klucza prywatnego/pliku JSON i hasła. ',
...
ADD_Ledger_0a               : 'Otwórz MyKowalaWallet ponownie na bezpiecznym połączeniu (SSL) ',
ADD_Ledger_0b               : 'Otwórz MyKowalaWallet w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Otwórz MyKowalaWallet ponownie na bezpiecznym połączeniu (SSL) ',
ADD_DigitalBitbox_0b        : 'Otwórz MyKowalaWallet w [Chrome](https://www.google.com/chrome/browser/desktop/) lub [Opera](https://www.opera.com/) ',
...
NODE_Warning                : 'Twój węzeł musi obsługiwać HTTPS, aby można było się połączyć z nim przez testnet-wallet.kowala.io. Możesz pobrać [repozytorium MyKowalaWallet](https://github.com/kvhnuke/etherwallet/releases/latest) i uruchomić lokalnie aby połączyć się z dowolnym węzłem. Możesz też pobrać darmowy certyfikat SSL przez [LetsEncrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " na ", // "I want to swap my X kUSD for X BTC"
...
SWAP_progress_3             : "Otrzymano! ", // kUSD Received!
SWAP_progress_4             : "Wysyłanie Twoich {{orderResult.output.currency}} ",
SWAP_progress_5             : "Zlecenie Zakończone ",
SWAP_order_CTA              : "Wyślij ", // Please send 1 kUSD...
SWAP_unlock                 : "Odblokuj Twój portfel, aby wysłać kUSD lub Tokeny wprost z tej strony. ",
...
ERROR_17                    : 'Niewystarczające środki. Konto, z którego wysyłasz transakcję nie posiada wystarczających funduszy. Musisz mieć **0.01 kUSD** na koncie, aby pokryć koszty paliwa. Doładuj konto i spróbuj ponownie. ',
...
ERROR_28                    : '**Potrzebujesz plik Keystore i hasło, lub Klucz Prywatny** aby uzyskać dostęp do tego portfela w przyszłości. Wykonaj zewnętrzną kopię bezpieczeństwa! Nie ma możliwości odzyskania portfela jeżeli go nie zapiszesz. Wejdź na [stronę pomocy](https://testnet-wallet.kowala.io/#help) po instrukcje. ',
...
HELP_0_Desc_1               : 'MyKowalaWallet daje Ci możliwość generowania nowych portfeli abyś mógł przechowywać własne środki samodzielnie, nie na portalu wymiany walut. Ten proces odbywa się w całości na Twoim komputerze, nie na naszych serwerach. Z tego powodu, gdy generujesz nowy portfel, **to Ty jesteś odpowiedzialny za jego bezpieczne przechowywanie**. ',
...
HELP_2b_Title               : '2b) Jak mogę utworzyć portfel w 100% odizolowany od sieci globalnej (Cold Wallet) wykorzystując MyKowalaWallet? ',
...
HELP_3_Desc_3               : 'Przejdź na zakładkę "Wyświetl informacje o portfelu" na stronie testnet-wallet.kowala.io. ',
...
HELP_4_Title                : '4) Jak wysłać kUSD z jednego portfela na inny? ',
...
HELP_4_Desc_2               : 'Przejdź na zakładkę "Wyślij kUSD". ',
...
HELP_4CX_Title              : '4)Jak wysłać kUSD używając MyKowalaWallet CX? ',
HELP_4CX_Desc_1             : 'Najpierw musisz dodać portfel. Po dodaniu portfela masz 2 możliwości do wyboru: funkcja "Wyślij" z ikony Rozszerzenia Chrome lub zakładka "Wyślij kUSD" ze strony "Moje Portfele". ',
...
HELP_4CX_Desc_12            : 'Używając zakładki "Wyślij kUSD" ',

HELP_5_Title                : '5) Jak uruchomić MyKowalaWallet offline/lokalnie? ',
HELP_5_Desc_1               : 'Możesz uruchomić MyKowalaWallet lokalnie ze swojego komputera zamiast z serwerów GitHub\'a. Możesz wygenerować portfel całkowicie offline\'owo i wysyłać transakcje z zakładki "Wyślij offline". ',
HELP_5_Desc_7               : 'MyKowalaWallet działa teraz w całości na Twoim komputerze. ',
HELP_5_Desc_8               : 'W razie gdybyś nie wiedział, musisz zachować cały folder, aby strona działała prawidłowo, nie tylko `index.html`. Nie ruszaj i nie przenoś nic innego w folderze. Jeżeli zachowujesz kopie repozytorium MyKowalaWallet na przyszłość, zalecamy przechowywać je w formie spakowanego pliku ZIP, aby mieć pewność, że jego zawartość się nie zmieniła. ',
HELP_5_Desc_9               : 'Ponieważ ciągle aktualizujemy MyKowalaWallet, zalecamy co jakiś czas aktualizować  zapisaną wersję repozytorium. ',
...
HELP_7_Desc_1               : 'Przejdź na zakładkę "Wyślij kUSD i Tokeny". ',
...
HELP_8_Desc_1               : 'MyKowalaWallet nie jest usługą portfela internetowego. Nie posiadasz loginu i nic nie jest zapisywane na naszych serwerach. To tylko interfejs, który pozwala korzystać z sieci Ethereum. ',
HELP_8_Desc_2               : 'Jeżeli testnet-wallet.kowala.io zostanie wyłączona, musiałbyś znaleźć inny sposób (jak Ethereum Wallet / Mist) na korzystanie z sieci Ethereum. Nie musiałbyś jednak wypłacić swoich środków z MyKowalaWallet, ponieważ one nie znajdują się na MyKowalaWallet, a na portfelach, które zostały wygenerowane za pomocą naszej strony. ',
...
HELP_8_Desc_4               : 'W dodatku prawdopodobieństwo zamknięcia przez nas strony testnet-wallet.kowala.io jest bliskie zeru. Koszty utrzymania strony są prawie żadne, ponieważ nie przechowujmy żadnych informacji. Jeśli nawet strona zostanie zamknięta, jest ona również i zawsze będzie publicznie dostępna na [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Możesz ściągnąć paczkę ZIP i uruchomić MyKowalaWallet lokalnie na własnym komputerze. ',

HELP_8CX_Title              : '8) Co się stanie jeżeli MyKowalaWallet CX zniknie? ',
...
HELP_8CX_Desc_2             : 'Z tego powodu, jest **niezmiernie ważnym** aby wykonywać kopie bezpieczeństwa wszystkich nowych portfeli wygenerowanych za pomocą MyKowalaWallet CX. W ten sposób, jeżeli cokolwiek stanie się MyKowalaWallet CX lub Twojemu komputerowi, wciąż będziesz miał wszelkie niezbędne informacje potrzebne aby odzyskać dostęp do Twoich portfeli. Zobacz punkt 2a aby dowiedzieć się jak wykonać kopie bezpieczeństwa. ',
HELP_8CX_Desc_3             : 'Jeżeli z jakiegoś powodu MyKowalaWallet CX zniknie z Chrome Store, możesz wciąż znaleźć kod źródłowy na Github\'ie i załadować manualnie do Chrome. Zobacz pkt. 5 powyżej. ',

HELP_9_Title                : '9) Czy zakładka "Wyślij kUSD" działa offline? ',
...
HELP_12_Title               : '12) Jak zaimportować portfel utworzony w MyKowalaWallet do geth / Ethereum Wallet / Mist? ',
HELP_12_Desc_1              : 'Używając pliku Keystore Geth/Mist z MyKowalaWallet v2+.... ',
...
HELP_13_Desc_1              : 'Oznacza to, że nie posiadasz wystarczającej ilości kUSD na koncie, aby pokryć koszty paliwa. Każda transakcja (przesyłanie tokenów lub interakcja z kontraktem) wymaga paliwa, które jest opłacane w kUSD\'ach. Wyświetlona wartość jest ilością potrzebną na pokrycie kosztów transakcji w Wei\'ach. Podziel tą liczbę przez `1000000000000000000` i odejmij wartość kUSD, którą chciałeś wysłać (jeśli wysyłałeś kUSD). Otrzymasz wartość, jaką musisz przesłać na swoje konto, aby wykonać transakcję.',

HELP_14_Title               : '14) Niektóre strony wykorzystują ruchy myszką przy generowaniu klucza prywatnego. MyKowalaWallet tego nie robi. Czy generator liczb losowych w MyKowalaWallet jest bezpieczny? ',
HELP_14_Desc_1              : 'Chociaż generowanie liczb losowych przy udziale ruchów myszki jest sprytnie pomyślane i rozumiemy dlaczego ludzie to lubią, to jednak rzeczywistość jest taka, że window.crypto zapewnia większą entropię niż ruchy myszką. Generowanie z ruchów myszki nie jest niebezpieczne, ale my (oraz znaczna liczba innych ekspertów kryptografii) wierzymy w window.crypto. W dodatku MyKowalaWallet może być używane na urządzeniach dotykowych. Tutaj można przeczytać [rozmowę rozeźlonego reddit\'ora i Vitalik\'a Buterin\'a odnośnie ruchów myszki kontra window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) a tutaj jest [specyfikacja window.crypto w3](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Title            : 'Bezpieczeństwo - MyKowalaWallet CX ',
...
HELP_Sec_Desc_4             : 'Sprawdź adres URL -- Ta strona jest serwowana przez GitHub. Kod źródłowy jest dostępny pod: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Strona jest dostępna pod domenami: [https://testnet-wallet.kowala.io](https://testnet-wallet.kowala.io). ',
