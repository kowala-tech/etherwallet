...
tx_notFound_4               : 'Please use the dropdown in the top-right & select a different kUSD node (e.g. `kUSD (Etherscan.io)` or `kUSD (Infura.io)` or `kUSD (MyKowalaWallet)`) and check again.',
...
GEN_Help_12                 : 'Use it to unlock your wallet via MyKowalaWallet (or Mist, Geth, Parity and other wallet clients.) ',
...
GAS_LIMIT_Desc              : 'Gas limit is the amount of gas to send with your TX. `TX fee` = gas price * gas limit & is paid to miners for including your TX in a block. Increasing this number will not get your TX mined faster. Sending kUSD = `21000`. Sending Tokens = ~`200000`.',
...
TXFEE_Desc                  : 'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> kUSD here](https://testnet-wallet.kowala.io/helpers.html)',
...
NAV_SendEther               : 'Gửi kUSD và Tokens ',
...
/* General */
x_Access                    : 'Access ',
x_AddessDesc                : 'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you kUSD or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere. Bạn có thể xem đây là Địa chỉ ví cá nhân của bạn. Bạn có thể gửi "Địa chỉ ví" này đến người mà bạn muốn nhận kUSD từ họ. Biểu tượng bên cạnh giúp việc nhận dạng "Địa chỉ ví" của bạn dễ dàng hơn. ',
...
MEW_Tagline                 : 'Open Source JavaScript Client-Side kUSD Wallet ',
CX_Tagline                  : 'Open Source JavaScript Client-Side kUSD Wallet Chrome Extension ',
...
/* full sentence reads "You are about to send "10 kUSD" to address "0x1234". Are you sure you want to do this? " */
...
TRANS_warning               : 'Nếu bạn sử dụng chức năng "Chỉ kUSD" hoặc "Chỉ ETC" trong việc gửi đi thông qua một hợp đồng thông minh. Những dịch vụ có chức năng chấp nhận các giao dịch. Đọc Thêm. ',
TRANS_advanced              : 'Nâng Cao: Thêm Dữ Liệu ',
TRANS_data                  : 'Dữ Liệu: ',
TRANS_gas                   : 'Gas Limit: ',
TRANS_sendInfo              : 'Mỗi Giao dịch Phổ Thông sử dụng hết 21000 gas có giá tương đương 0.000441 kUSD. Chúng tôi áp dụng giá Gas dành cho một giao dịch cao hơn so với mức tối thiểu là 0.000000021 kUSD nhằm đảm bảo một giao dịch được diễn ra nhanh. Chúng tôi hoàn toàn không nhận được khoản tiền phát sinh nào từ phí giao dịch. ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Giao Dịch "Chỉ kUSD" Và "Chỉ ETC" ',
TRANSModal_Content_0        : 'Một số lưu ý về sự khác biệt của từng loại giao dịch và sự khác biệt của từng dịch vụ: ',
TRANSModal_Content_1        : '**kUSD (Giao Dịch Phổ Thông): ** Phương pháp này mặc định rằng nó sẽ tạo giao dịch từ một địa chỉ gửi đến địa chỉ nhận khác và nó sẽ tiêu thụ hết 21000 gas. Theo giả thuyết thì bất kì số kUSD gửi đi thông qua phương pháp này sẽ được thực hiện lại tương tự trên chuổi ETC. ',
TRANSModal_Content_2        : '**Chỉ kUSD: ** Phương pháp này sẽ thực hiện giao dịch thông qua [Hợp đồng thông minh nhằm "tránh việc phát lại" được phát triển bởi Timon Rapp (theo lời cảnh báo của VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) vì vậy giao dịch này chỉ được thực hiện trên chuổi **kUSD**. ',
...
NODE_Warning                : 'Your node must be HTTPS in order to connect to it via testnet-wallet.kowala.io. You can [download the MyKowalaWallet repo & run it locally](https://github.com/kvhnuke/etherwallet/releases/latest) to connect to any node. Or, get free SSL certificate via [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Node Name',
NODE_Port                   : 'Node Port',
...
ADD_Ledger_0a               : 'Hảy mở lại trang MyKowalaWallet trên một kết nối có tính bảo mật (SSL) ',
ADD_Ledger_0b               : 'Sử dụng [Chrome](https://www.google.com/chrome/browser/desktop/) hoặc [Opera](https://www.opera.com/) Để mở lại trang MyKowalaWallet ',
ADD_Ledger_scan             : 'Kết nối với Ledger Wallet ',
ADD_MetaMask                : 'Connect to MetaMask ',
ADD_Ledger_scan             : 'Kết nối với Ledger Nano S ',
x_DigitalBitbox             : 'Digital Bitbox ',
ADD_DigitalBitbox_0a        : 'Hảy mở lại trang MyKowalaWallet trên một kết nối có tính bảo mật (SSL) ',
ADD_DigitalBitbox_0b        : 'Sử dụng [Chrome](https://www.google.com/chrome/browser/desktop/) hoặc [Opera](https://www.opera.com/) Để mở lại trang MyKowalaWallet ',
...
MYWAL_Content_3             : 'Nếu bạn muốn sử dụng địa chỉ Ví này với MyKowalaWallet CX trong tương lai, bạn sẽ cần phải tự thêm vào lại bằng cách sử dụng tập tin Private Key / JSON và mật khẩu. ',
...
ERROR_17                    : 'Bạn cần có ít nhất **0.01 kUSD** trong tài khoản để thanh toán chi phí gas. Hãy thêm một số ether và thực hiện lại. ',
...
ERROR_28                    : '**Bạn cần sử dụng tập tin chứa định dạng Keystore/JSON cùng với Mật khẩu hoặc Private Key của bạn** cho việc đăng nhập vào ví này trong tương lai. Hãy sao lưu và cất giữ nó cẩn thận tại kho lưu trữ của bạn! Không có cách nào đễ khôi phục Ví của bạn nếu bạn không sao lưu dữ liệu ví lại. Đọc Thêm [trang trợ giúp] (https://testnet-wallet.kowala.io/#help) đễ được hướng dẫn cụ thể. ',
...
HELP_Remind_Desc_1          : '**Ethereum, testnet-wallet.kowala.io & MyKowalaWallet CX, và các nền tảng khác từ Javascript libraries mà chúng tôi sử dụng đang được phát triển một cách tích cực.** Mặc dù toàn bộ đã được chúng tôi kiễm tra rất kỹ lưỡng và hàng chục nghìn địa chỉ Ví đã được tạo thành công từ người sử dụng trên toàn cầu, nhưng vẫn có những vấn đề có thể xảy ra làm cho kUSD của bạn bị mất đi. Xin vui lòng không nên đầu tư với số tiền nhiều hơn khả năng mà bạn đã cho rằng nó sẽ mất và hãy luôn cẩn thận. Trong trường hợp rủi ro xảy ra, chung tôi rất chân thành xin lỗi. Tuy nhiên **Chúng tôi sẽ không chịu bất cứ một trách nhiệm nào đối với số lượng kUSD mà bạn đã bị mất!**. ',
HELP_Remind_Desc_2          : 'testnet-wallet.kowala.io & MyKowalaWallet CX không phải "Ví Web". Vì vậy bạn không tạo tài khoản sau đó gửi số kUSD của bạn cho chúng tôi dễ giữ hộ. Toàn bộ Dữ liệu sẽ không bao giờ bị rò rỉ ra khỏi máy tính/trình duyệt của bạn. Chúng tôi xây dựng nó nhằm giúp người sử dụng có thể đễ dàng tạo mới, lưu trữ và truy cập thông tin Ví của bạn và tương tác với Blockchain. ',
...
HELP_0_Desc_1               : 'MyKowalaWallet giúp bạn có khả năng tạo Ví mới dùng dễ lưu trữ số lượng kUSD của ban bởi chính mình, Ví được tạo ra không nằm trên bất cứ một sàn giao dịch nào. Quá trình tạo Ví điễn ra hoàn toàn trên máy tính cá nhân của bạn chứ không phải trên hệ thống máy chủ của chúng tôi. Do đó, khi bạn khởi tạo một Ví mới, **bạn chịu trách nhiệm hoàn toàn về vấn đề sao lưu dữ liệu đối với Ví được tạo**. ',
...
HELP_0_Desc_5               : 'Gửi kUSD đến Ví mới này. ',
...
HELP_2a_Desc_2              : 'Lưu lại địa chỉ Ví. Bạn có thể giữ nó cho chính mình hoặc chia sẽ nó cho bất cứ ai. Người khác có thể gửi kUSD cho bạn thông qua địa chỉ Ví của bạn. ',
HELP_2a_Desc_3              : 'Private key. Không được chia sẽ Private key cho bất cứ ai. Private key rất cần thiết khi bạn muốn truy cập vào Ví và Gửi đi một lượng kUSD! hiện tại có 3 phiên bản lưu trữ dành cho Private Key: ',
...
HELP_2b_Title               : '2b) Làm thế nào dễ bảo mật Ví / offline / lưu trữ lạnh cùng với MyKowalaWallet? ',
...
HELP_3_Desc_1               : '**Trước khi bạn gửi số lượng kUSD vô Ví mới của bạn**, bạn nên chắc chắn rằng bạn đã truy cập vào Ví thành công. ',
HELP_3_Desc_2               : 'Đi đến trang "Xem Thông Tin Ví". ',
HELP_3_Desc_3               : 'Bạn hãy đi đến trang testnet-wallet.kowala.io "Xem Thông Tin Ví". ',
...
HELP_4_Title                : '4) Làm thế nào dễ gửi kUSD từ Ví này sang Ví khác ? ',
HELP_4_Desc_1               : 'Nếu như bạn dự định dễ chuyển một số lượng lớn kUSD, bạn nên gửi đi một lượng nhỏ đến Ví của bạn dễ thử nghiệm, nhằm xác định chắc chắn tất cả chức năng đều hoạt động đúng như dự định. ',
HELP_4_Desc_2               : 'Đi đến trang "Gửi kUSD và Tokens". ',
...
HELP_4_Desc_7               : 'Điền số lượng kUSD mà bạn muốn gửi đi.Hoặc bạn có thể chọn vào phần "Gửi toàn bộ số dư" nếu bạn muốn chuyển đi toàn bộ số kUSD mà bạn hiện có trong tài khoản. ',
...
HELP_4CX_Title              : '4) Làm thế nào dễ gửi đi kUSD bằng cách sử dụng MyKowalaWallet CX? ',
HELP_4CX_Desc_1             : 'Trước tiên, bạn cần phải thêm Ví của bạn vào. Sau khi thực hiện xong, Bạn sẽ có 2 lựa chọn: Chức năng "Gửi Nhanh" từ biểu tượng nằm trên thanh công cụ tiện ích của Google Chrome hoặc chọn vào "Gửi kUSD và Tokens" dễ đi đến trang trình duyệt. ',
...
HELP_4CX_Desc_7             : 'Điền số lượng kUSD mà bạn muốn gửi đi.Hoặc bạn có thể chọn vào phần "Gửi toàn bộ số dư" nếu bạn muốn chuyển đi toàn bộ số kUSD mà bạn hiện có trong tài khoản. ',
...
HELP_4CX_Desc_12            : 'Sử dụng trang "Gửi kUSD và Tokens" ',

HELP_5_Title                : '5) Làm thế nào dễ kích hoạt testnet-wallet.kowala.io với tính năng offline? ',
HELP_5_Desc_1               : 'Bạn hãy kích hoạt testnet-wallet.kowala.io trên máy tính của bạn thay thế cho việc chạy trên máy chủ của Github. Bạn có thể khởi tạo Ví mới hoàn toàn trong tình trạng offline và gửi giao dịch đi từ trang "Giao dịch Offline". ',
HELP_5_Desc_7               : 'testnet-wallet.kowala.io sẽ được chạy hoàn toàn trên máy tính của bạn. ',
HELP_5_Desc_8               : 'Trong trường hợp bạn chưa quen với việc sử dụng này, bạn cần nên giữ nguyên toàn bộ thư mục và chừa một phần dung lượng vừa đủ để chạy trang web, không chỉ riêng tập tin `index.html`. Không nên thử mở lên hoặc di chuyển bất cứ một tập tin nào trong thư mục. Nếu bạn lưu trữ một bản sao tập tin repo của MyKowalaWallet, chúng tôi khuyên bạn nên lưu trữ tập tin nén nhằm chắc chắn các nội dung của thư mục được giữ nguyên. ',
HELP_5_Desc_9               : 'Cũng như việc chúng tôi liên tục cập nhật testnet-wallet.kowala.io, vì vậy chúng tôi khuyên bạn nên cập nhận định kì cho các tập tin đã Lưu của định dạng repo. ',
...
HELP_7_Desc_1               : 'Đi đến trang "Gửi kUSD và Tokens". ',
...
HELP_7_Desc_14              : 'Sau đó một thông báo sẽ xuất hiện. Xác thực lại số lượng kUSD và địa chỉ đến. sau đó nhấn vào nút  "Có, Tôi chắc chắn! Hãy thực hiện giao dịch.". ',
...
HELP_8_Desc_1               : 'MyKowalaWallet không phải là Ví online. Bạn không cần phải đăng nhập và không có bất cứ gì được lưu lại trên máy chủ của chúng tôi. Đây chỉ đơn giản là một giao diện cho phép bạn tương tác với blockchain. ',
HELP_8_Desc_2               : 'Nếu testnet-wallet.kowala.io bị sập, bạn sẽ phải tìm một giải pháp khác (như là geth hoặc Ví Ethereum / Mist) dễ tiếp tục thực hiện giao dịch. Nhưng bạn không cần thiết phải "Mang" kUSD của bạn ra khỏi MyKowalaWallet bởi vì số kUSD đó không nằm trong MyKowalaWallet. Bởi vì số kUSD đó đang nằm trong Ví Ethereum được khởi tạo thông qua trang của chúng tôi. ',
...
HELP_8CX_Desc_2             : 'Điều đó cho thấy tầm **quan trọng** đối với việc sao lưu toàn bộ thông tin và dữ liệu Ví mới được khởi tạo từ bạn tại trang MyKowalaWallet CX. Và việc sao lưu dữ liệu là cách dự phòng tốt khi những vấn đề xấu có thể xảy ra đối với MyKowalaWallet CX hoặc máy tính của bạn, và nó giúp bạn có toàn bộ thông tin cần thiết dễ bạn có thể truy cập vào Ví và quản lý được số kUSD của bạn. xem lại phần #2a dễ rõ hơn về cách sao lưu dữ liệu. ',
HELP_8CX_Desc_3             : 'Nếu vì một lý do bất kì buộc MyKowalaWallet CX không tồn tại trên kho tiện ích của Chrome, bạn có thể tìm thấy mã nguồn trên Github và tải về máy của bạn. Xem phần #5 ở trên. ',

HELP_9_Title                : '9) Có phải trang "Gửi kUSD" là trang offline? ',
...
HELP_10_Desc_11             : 'Trên máy tính online của bạn, bạn hãy dán chữ ký giao dịch vào khung điền văn bản tại bước #3 và chọn nút "Gửi kUSD". Việc làm này sẽ phát sóng đi giao dịch của bạn. ',

HELP_12_Title               : '12) Làm thế nào dễ tôi sử dụng Ví được khởi tạo từ MyKowalaWallet trên geth / Ví Ethereum / Mist? ',
HELP_12_Desc_1              : 'Bạn phải sử dụng tập tin chứa định dạng JSON dành cho Geth/Mist từ MyKowalaWallet v2+.... ',
...
HELP_14_Title               : '14) Một số trang khi khởi tạo Private key thông qua việc di chuyển con trỏ chuột máy tính trên màn hình. testnet-wallet.kowala.io không làm theo cách này. Các ký tự Private key được tạo ra trên trang MyKowalaWallet một cách an toàn nhất? ',
HELP_14_Desc_1              : 'Mặc dù chúng tôi hiểu với việc di chuyển chuột xung quanh màn hình như vậy sẽ khá thú vị, nhưng thực tế window.crypto sẽ đảm bảo việc tạo ra những "dữ liệu ngẫu nhiên" hơn đối với việc di chuyển chuột. Việc di chuyển chuột như vậy không phải là không an toàn, nhưng thông qua rất nhiều những thử nghiệm về mật mã khác thì chúng tôi hoàn toàn tin tưởng vào window.crypto. Ngoài ra, testnet-wallet.kowala.io còn được sử dụng trên những thiết bị cảm ứng. Đây là [Cuộc tranh cải tức giận giữa một redditor và Vitalik Buterin Liên quan đến vấn đề Di chuyển con chuột với window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_15_Desc_1              : 'Tài khoản của bạn chỉ tồn tại duy nhất trên một Blockchain Explorer và tài khoản được kích hoạt khi bởi chính nó khi bạn dùng tài khoản đó và chuyển kUSD vào tức khắc tài khoản sử dụng sẽ hiển thị trên hệ thống Blockchain Explorer thích hợp. ',
...
HELP_21_Title               : '21) có thể xảy ra trường hợp có một cá nhân nào đó sử dụng ngẫu nhiên một Private key dễ thấy được số dư tài khoản của một người khác và chuyển số kUSD đó vào địa chỉ mà cá nhân dó sở hữu hay không? ',
HELP_21_Desc_1              : 'Đối với phiên bản ngắn: Điều đó có thể xảy ra, nhưng việc chọn ngẫu nhiên dễ nhằm tìm kiếm một tài khoản chứa kUSD là một việc làm mất rất nhiều thời gian và cũng có thể mất cả vài chục năm dễ đạt được mục đích đó. bởi vậy trường hợp này được coi là rất khó dễ xảy ra. ',
...
HELP_SecCX_Title            : 'Bảo mật - MyKowalaWallet CX ',
...
HELP_SecCX_Desc_6           : 'Nếu chúng tôi mã hoá chúng, thì bạn phải điền mật khẩu khi bạn muốn xem số dư hiện tại của tài khoản bạn và xem tên gọi của tài khoản đó. Nếu như bạn cảm thấy đáp ứng nhu cầu bạn đã nêu, Chúng tôi cung cấp thêm lựa chọn khác dành cho bạn đó là testnet-wallet.kowala.io thay vì phải sử dụng Chrome Extension. ',
