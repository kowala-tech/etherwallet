...
tx_notFound_4               : 'Veuillez utiliser le menu déroulant en haut à droite & sélectionner un nœud kUSD différent (par ex. `kUSD (Etherscan.io)`, `kUSD (Infura.io)` ou `kUSD (MyKowalaWallet)`) puis revérifiez.',
...
GEN_Help_12                 : 'Utilisez-le pour déverouiller votre portefeuille avec MyKowalaWallet (ou Mist, Geth, Parity et autres clients.) ',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `GAS limite` * le `prix du GAS`. [Vous pouvez convertir GWEI -> kUSD ici.](https://testnet-wallet.kowala.io/helpers.html)',
...
NAV_SendEther               : 'Envoyer des kUSD et des Tokens ',
...
/* General */
x_Access                    : 'Accès ',
x_AddessDesc                : 'Aussi appelée `adresse` ou `clé publique`. C\'est ce que vous donnez aux gens pour qu\'ils puissent vous envoyer des kUSD ou des Tokens. Remarquez l\'icône colorée. Cette icône doit être identique quand vous entrez votre adresse quelque part.', //Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere. Cette icône est une façon simple de reconnaître votre adresse.
x_Address                   : 'Votre adresse ',
x_Cancel                    : 'Annuler ',
x_CSV                       : 'Fichier CSV (non-chiffré) ',
x_Download                  : 'Télécharger ',
x_Json                      : 'Fichier JSON (non-chiffré) ',
x_JsonDesc                  : 'C\'est la version non-chiffrée au format JSON de votre clé privée. Cela signifie que vous n\'avez pas besoin de votre mot de passe pour l\'utiliser mais que toute personne qui trouve ce JSON peut accéder à votre portefeuille et vos kUSD sans mot de passe. ',
...
MEW_Tagline                 : 'Portefeuille d\'kUSD Open Source, écrit en JavaScript',
CX_Tagline                  : 'Extension Chrome de portefeuille d\'kUSD Open Source JavaScript',
...
ADD_Warning_1               : 'Vous pouvez ajouter n\'importe quel compte pour l\'afficher dans l\'onglet "portefeuilles" sans uploader une clé privée. Cela ne veut **pas** dire que vous aurez accès à ce portefeuille, ni que vous pouvez transférer des kUSD depuis ce portefeuille. ',
...
SENDModal_Content_4         : 'NOTE : Si vous renontrez une erreur, il est très probable que vous deviez ajouter des kUSD à votre compte pour couvrir les coûts (en GAS) d\'envoi des Tokens. Le GAS est payé en kUSD.',
...
TRANS_warning               : 'L\'emploi des fonctions "kUSD seulement" et "ETC seulement" vous fait passer par un contrat. Certains services ont des problèmes avec ces transactions. En savoir plus.',
TRANS_advanced              : '+ Avancé : Ajouter des données',
TRANS_data                  : 'Données',
TRANS_sendInfo              : 'Une transaction standard utilisant 21000 GAS coûtera 0,000441 kUSD. Le prix du GAS, de 0.000000021 kUSD, que nous avons choisi est légèrement supérieur au minimum assurant une confirmation rapide. Nous ne prenons pas de frais de transaction.',
TRANS_gas                   : 'GAS limite', // changed in ENG to Gas Limit:

/* Send Transaction Modals */
TRANSModal_Title            : 'Transactions "kUSD seulement" et "ETC seulement"',
TRANSModal_Content_0        : 'Note sur les transactions et services divers :',
TRANSModal_Content_1        : '**kUSD (Transaction standard) :** Génère une transaction standard depuis une adresse directement vers une autre. Son GAS par défaut est de 21000. Il est probable que toute transaction d\'kUSD envoyée de cette manière sera réexécutée sur la chaîne ETC.',
TRANSModal_Content_2        : '**kUSD seulement :** Envoi à travers le [contrat anti-réexécution de Timon Rapp (recommandé par VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) afin de n\'envoyer que sur la chaîne **kUSD**.',
...
MYWAL_Content_3             : 'Si vous voulez utiliser ce portefeuille avec MyKowalaWallet CX à l\'avenir, vous devrez le rajouter manuellement en utilisant la clé privée / fichier JSON et le mot de passe.',
...
ADD_Ledger_0a               : 'Rouvrir MyKowalaWallet sur une connexion sécurisée (SSL)',
ADD_Ledger_0b               : 'Rouvrir MyKowalaWallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
ADD_DigitalBitbox_0a        : 'Rouvrir MyKowalaWallet sur une connexion sécurisée (SSL)',
ADD_DigitalBitbox_0b        : 'Rouvrir MyKowalaWallet avec [Chrome](https://www.google.com/chrome/browser/desktop/) ou [Opera](https://www.opera.com/)',
...
NODE_Warning                : 'Votre nœud doit être en HTTPS pour vous y connecter via testnet-wallet.kowala.io. Vous pouvez [télécharger MyKowalaWallet et le lancer localement](https://github.com/kvhnuke/etherwallet/releases/latest) pour vous connecter à un nœud quelconque, ou obtenir un certificat SSL gratuit via [LetsEncrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " contre", // "I want to swap my X kUSD for X BTC"
...
SWAP_progress_3             : "reçu !", // kUSD Received!
SWAP_progress_4             : "Envoi de vos {{orderResult.output.currency}}",
SWAP_progress_5             : "Ordre exécuté",
SWAP_order_CTA              : "Envoyer ", // Please send 1 kUSD...
SWAP_unlock                 : "Déverrouillez votre portefeuille pour envoyer des kUSD ou des tokens directement depuis cette page.",
...
TranslatorName_1            : '[Simon P](https://testnet-wallet.kowala.io/?gaslimit=21000&to=0x89a18eE46b5aabC62e94b1830881887D04C687f3&value=1.0#send-transaction) ·',
...
HELP_0_Desc_5               : 'Transférez de l\'kUSD vers ce nouveau portefeuille.',
...
HELP_2a_Desc_2              : 'Sauvegardez l\'adresse. Vous pouvez la garder pour vous-même ou la partager avec d\'autres personnes qui, de cette manière, peuvent vous envoyer de l\'kUSD.',
HELP_2a_Desc_3              : 'Sauvegardez votre clef privée en plusieurs exemplaires. Ne la partagez avec personne. Votre clef privée est nécessaire pour accéder à votre kUSD et pour l\'envoyer ! Il existe 3 types de clef privée :',
...
HELP_2b_Title               : '2b) Comment puis-je gérer en toute sécurité un stockage hors ligne avec MyKowalaWallet ?',
...
HELP_3_Desc_1               : '**Avant d\'envoyer de l\'kUSD à votre portefeuille**, vous devez vous assurer que vous y avez accès.',
HELP_3_Desc_2               : 'Naviguez vers la page "Visualisation d\'un portefeuille".',
HELP_3_Desc_3               : 'Naviguez vers la page Visualisation d\'un portefeuille" de testnet-wallet.kowala.io.',
...
HELP_3_Desc_8               : 'Si vous désirez détenir une grande quantité d\'kUSD, nous recommandons de commencer par envoyer une petite somme depuis le nouveau portefeuille avant d\'y déposer une somme importante. Envoyez 0,001 kUSD vers le nouveau portefeuille, accédez-y puis envoyez ces 0,001 kUSD vers une autre adresse, et vérifiez que tout a fonctionné sans encombre.',

HELP_4_Title                : '4) Comment puis-je envoyer de l\'kUSD d\'un portefeuille vers un autre ?',
HELP_4_Desc_1               : 'Si vous désirez transférer une grande quantité d\'kUSD, vous devez d\'abord essayer d\'en envoyer un petit montant vers votre portefeuille pour vous assurer que tout fonctionne comme prévu.',
HELP_4_Desc_2               : 'Naviguez vers la page "Envoyer des kUSD et des Tokens".',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'kUSD avec MyKowalaWallet CX ?',
HELP_4CX_Desc_1             : 'D\'abord, vous devez ajouter un portefeuille. Ceci fait, deux possibilités s\'offrent à vous : la fonctionnalité "Envoi rapide" de l\'icône de l\'extension Chrome ou la page "Envoyer des kUSD et des Tokens".',
...
HELP_4CX_Desc_12            : 'Avec la page "Envoyer des kUSD et des Tokens" ',

HELP_5_Title                : '5) Comment puis-je lancer testnet-wallet.kowala.io hors ligne (en local) ?',
HELP_5_Desc_1               : 'Vous pouvez lancer testnet-wallet.kowala.io sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne".',
HELP_5_Desc_7               : 'testnet-wallet.kowala.io tourne maintenant complètement sur votre ordinateur.',
HELP_5_Desc_8               : 'Au cas où cela ne vous est pas familier, vous devez conserver l\'intégralité du dossier pour faire tourner le site web et non uniquement `index.html`. Ne touchez à rien, ne déplacez rien dans le dossier. Si vous stockez une sauvegarde du repo MyKowalaWallet pour l\'avenir, nous vous recommandons de ne stocker que le ZIP afin d\'être sûr que le contenu du dossier restera intact.',
HELP_5_Desc_9               : 'Comme nous améliorons constamment testnet-wallet.kowala.io, nous vous recommandons de mettre régulièrement à jour votre version de sauvegarde.',
...
HELP_8_Desc_1               : 'MyKowalaWallet n\'est pas un portefeuille web. Vous n\'avez pas de compte dessus et rien n\'est jamais stocké sur nos serveurs. Ce n\'est qu\'une interface qui vous permet d\'interagir avec le blockchain.',
HELP_8_Desc_2               : 'Si testnet-wallet.kowala.io venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Ethereum Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre kUSD depuis MyKowalaWallet parce qu\'il ne se trouve pas dans MyKowalaWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
...
HELP_8CX_Desc_2             : 'Cela dit, il est **très important** que vous sauvegardiez toutes les données de tous les portefeuilles générés par MyKowalaWallet CX. De cette manière, si quoi que ce soit arrivait à MyKowalaWallet CX ou à votre ordinateur, vous conserveriez toutes les informations nécessaires pour accéder à votre kUSD. Voir #2a pour la sauvegarde de vos portefeuilles.',
HELP_8CX_Desc_3             : 'Si, pour une raison quelconque, MyKowalaWallet CX disparaissait du Chrome Store, vous pourrez en trouver le source sur [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages) et le charger manuellement. Voir #5 ci-dessus.',

HELP_9_Title                : '9) La page "Envoyer des kUSD et des Tokens" est-elle hors ligne ? ',
...
HELP_10_Desc_11             : 'Sur votre ordinateur en ligne, collez la transaction signée dans le champ texte et cliquez sur "Envoyez l\'kUSD". Ceci émettra votre transaction. ',
HELP_12_Title               : '12) Comment puis-je importer un portefeuille créé par MyKowalaWallet dans geth, Ethereum Wallet ou Mist ?',
HELP_12_Desc_1              : 'Avec un fichier Geth/Mist JSON de MyKowalaWallet v2+.... ',
...
HELP_13_Desc_1              : 'Cela signifie que vous n\'avez pas assez d\'kUSD sur votre compte pour couvrir les coûts en Gas. Chaque transaction (y compris pour les tokens et les contrats) demande du Gas, et ce Gas est payé en kUSD. Le nombre affiché est le montant requis pour couvrir le coût de la transaction en Wei. Prenez ce nombre, divisez-le par `10^18` (soit `1000000000000000000`) et soustrayez la somme en kUSD que vous essayiez d\'envoyer (si vous tentiez d\'envoyer de l\'kUSD). Cela vous donnera le montant en kUSD que vous avez besoin d\'ajouter à votre compte pour effectuer cette transaction.',

HELP_14_Title               : '14) Certains sites initialisent la génération de clef privée par les mouvements de la sours. Ce n\'est pas le cas de testnet-wallet.kowala.io. La génération de nombres aléatoires de MyKowalaWallet est-elle sûre ?',
HELP_14_Desc_1              : 'Bien que l\'interception des mouvement de la souris soit jugée attractive par beaucoup, et que nous en comprenions les raisons, la réalité est que window.crypto assure plus d\'entropie que les mouvements de votre souris. L\'utilisation de ces mouvements est sûre mais nous (ainsi que de nombreux projets crypto) avons de bonnes raisons de croire en window.crypto. De plus, testnet-wallet.kowala.io peut être utilisé sur des périphériques tactiles. Voici une [conversation entre un redditeur rageur et Vitalik Buterin à propos des mouvements de souris et window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) et voici [les spécifications w3 de window.crypto](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
...
HELP_15_Desc_1              : 'Les comptes n\'apparaissent dans un explorateur de blockchain qu\'après une activité, comme par exemple, un envoi ou une réception d\'kUSD.',
...
HELP_SecCX_Title            : 'Sécurité - MyKowalaWallet CX',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser testnet-wallet.kowala.io au lieu de cette extension Chrome.',
...
HELP_Sec_Desc_4             : 'Vérifiez l\'URL -- Ce site est servi par Github (et vous pouvez en voir le code source ici : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages)) vers [https://testnet-wallet.kowala.io](https://testnet-wallet.kowala.io).',
