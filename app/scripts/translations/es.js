...
tx_notFound_4               : 'Por favor usa el desplegable en la parte superior derecha y selecciona un nodo kUSD diferente (ej. `kUSD (Etherscan.io)` o `kUSD (Infura.io)` o `kUSD (MyKowalaWallet)`) y comprueba de nuevo.',
...
MEW_Tagline                 : 'Cartera kUSD JavaScript de código abierto ejecutado en el cliente ',
CX_Tagline                  : 'Cartera kUSD JavaScript de código abierto ejecutado en el cliente extensión Chrome ',
...
TRANS_warning               : 'Si utilizas las funciones "Sólo kUSD" o "Sólo ETC" estás enviando a través de un contrato. Algunos servicios tienen problemas aceptando estas transacciones. Leer más. ',
TRANS_advanced              : '+Avanzado: Añadir datos ',
TRANS_data                  : 'Datos ',
TRANS_gas                   : 'Límite de gas ',
TRANS_sendInfo              : 'Una transacción estándar que utiliza 21000 gas cuesta 0.000441 kUSD. Utilizamos un precio de gas de 0.000000021 kUSD, ligeramente por encima del mínimo, para asegurarnos de que se mina con rapidez. Nosotros no recibimos ninguna comisión por la transacción. ',

/* Send Transaction Modals */
TRANSModal_Title            : 'Transacciones "Sólo kUSD" y "Sólo ETC" ',
TRANSModal_Content_0        : 'Una nota sobre las distintas transacciones y servicios: ',
TRANSModal_Content_1        : '**kUSD (transacción estándar): ** Esto genera una transacción predeterminada directamente de una dirección a otra. Utiliza gas predeterminado de 21000. Es probable que cualquier transacción de kUSD enviada mediante este método se reproduzca (replay) en la cadena ETC. ',
TRANSModal_Content_2        : '**Sólo kUSD: ** Esto envía a través del [contrato de protección contra replay de Timon Rapp (según recomienda VB)](https://blog.ethereum.org/2016/07/26/onward_from_the_hard_fork/) de modo que envías solamente en la cadena **kUSD**. ',
...
MYWAL_Content_3             : 'Si en el futuro quieres utilizar esta cartera con MyKowalaWallet CX, tendrás que volver a añadirla manualmente utilizando Clave Privada/JSON y contraseña. ',
...
NODE_Warning                : 'Tu nodo debe ser HTTPS para poder conectar a él desde testnet-wallet.kowala.io. Para conectarte a cualquier nodo, puedes [descargar el repositorio de MyKowalaWallet y ejecutarlo localmente](https://github.com/kvhnuke/etherwallet/releases/latest). También puedes conseguir un certificado SSL gratuito a través de [Let\'s Encrypt](https://letsencrypt.org/)',
...
SWAP_init_2                 : " por ", // "I want to swap my X kUSD for X BTC"
...
SWAP_progress_3             : "¡Recibido! ", // kUSD Received!
SWAP_progress_4             : "Enviando tu {{orderResult.output.currency}} ",
SWAP_progress_5             : "Pedido completado ",
SWAP_order_CTA              : "Por favor, envía ", // Please send 1 kUSD...
SWAP_unlock                 : "Desbloquea tu cartera para enviar kUSD o tokens directamente desde esta página. ",
...
ADD_Ledger_0a               : 'Volver a abrir MyKowalaWallet en una conexión segura (SSL) ',
ADD_Ledger_0b               : 'Volver a abrir MyKowalaWallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ADD_DigitalBitbox_0a        : 'Volver a abrir MyKowalaWallet en una conexión segura (SSL) ',
ADD_DigitalBitbox_0b        : 'Volver a abrir MyKowalaWallet usando [Chrome](https://www.google.com/chrome/browser/desktop/) u [Opera](https://www.opera.com/) ',
...
ERROR_28                        :  '(error_29) **Necesitas tu archivo Keystore/JSON y la contraseña** (o clave privada) para acceder a esta cartera en el futuro. Por favor ¡guárdala y respáldala externamente! No hay modo de recuperar una cartera si no la guardas. Lee la [página de ayuda](https://testnet-wallet.kowala.io/#help) para instrucciones. You need this `Keystore File + Password` or the `Private Key` (next page) to access this wallet in the future. ', // 28
...
HELP_Remind_Desc_1          : '**Ethereum, testnet-wallet.kowala.io y MyKowalaWallet CX, así como algunas de las librerías JavaScript que utilizamos están en desarrollo activo.** Aunque hemos testeado ampliamente y decenas de miles de carteras han sido creadas exitosamente por personas en todo el planeta, siempre existe la remota posibilidad de que ocurra algo inesperado que haga que se pierdan tus kUSD. Por favor no inviertas más de lo que estés dispuesto a perder y, por favor, sé cuidadoso. Si algo ocurriera, lo lamentamos, pero **no somos responsables del kUSD perdido**. ',
HELP_Remind_Desc_2          : 'testnet-wallet.kowala.io y MyKowalaWallet CX no son "carteras web". No estás creando una cuenta ni nos estás entregando tus kUSD para que los guardemos. Toda tu información nunca abandona tu equipo o tu navegador. Te facilitamos que puedas crear, guardar y acceder a tu información e interactuar con la blockchain. ',
...
HELP_0_Desc_1               : 'MyKowalaWallet te permite generar nuevas carteras para poder almacenar tu kUSD por tu cuenta en lugar de en una casa de cambio. Este proceso tiene lugar por completo en tu equipo, no en nuestros servidores. Por lo tanto, cuando generes una nueva cartera, **eres responsable de hacer una copia de seguridad**. ',
...
HELP_0_Desc_5               : 'Transferir kUSD a la nueva cartera. ',
...
HELP_2b_Title               : '2b) ¿Cómo almaceno con seguridad/sin conexión/en frío con MyKowalaWallet? ',
...
HELP_3_Desc_3               : 'Ve a la página "Ver Información de las Carteras" de testnet-wallet.kowala.io. ',
...
HELP_4_Desc_2               : 'Ve a la página "Enviar kUSD y Tokens". ',
...
HELP_4CX_Title              : '4) ¿Cómo envío ether utilizando MyKowalaWallet CX? ',
HELP_4CX_Desc_1             : 'Antes de nada, necesitas añadir una cartera. Una vez hecho, tienes dos opciones: la función "Enviar" del icono de la extensión de Chrome o la página "Enviar kUSD y Tokens". ',
...
HELP_4CX_Desc_12            : 'Utilizando la página "Enviar kUSD y Tokens" ',

HELP_5_Title                : '5) ¿Cómo ejecuto testnet-wallet.kowala.io sin conexión/localmente? ',
HELP_5_Desc_1               : 'Puedes ejecutar testnet-wallet.kowala.io en tu equipo en lugar de desde los servidores de GitHub. Puedes generar una cartera totalmente sin conexión y enviar transacciones desde la página "Transacción sin conexión". ',
HELP_5_Desc_7               : 'testnet-wallet.kowala.io is now running entirely on your computer. ',
HELP_5_Desc_8               : 'Por si no tienes costumbre, es necesario guardar la carpeta completa para ejecutar la página web, no solamente `index.html`. No modifiques ni muevas nada dentro de la carpeta. Si estás guardando una copia del repositorio MyKowalaWallet para el futuro, recomendamos guardar únicamente el fichero ZIP para poder estar seguro de que el contenido permanezca intacto. ',
HELP_5_Desc_9               : 'Debido a que estamos constantemente actualizando testnet-wallet.kowala.io, recomendamos que actualices periódicamente tu versión guardada del repositorio. ',
...
HELP_8_Desc_1               : 'MyKowalaWallet no es una cartera web. No tienes un login y nunca se graba nada en nuestros servidores. You don\'t have a login and nothing ever gets saved to our servers. Simplemente es una interfaz que te permite interactuar con la cadena de bloques. ',
HELP_8_Desc_2               : 'Si testnet-wallet.kowala.io desapareciera, tendrías que encontrar otra manera de poder hacer lo que haces con nosotros (como por ejemplo obtener geth o Ethereum Wallet / Mist). Pero no necesitarías retirar tus ether de MyKowalaWallet porque no están en MyKowalaWallet. Están en la cartera que hayas generado a través de nuestro sitio. ',
...
HELP_8_Desc_4               : 'Además, la probabilidad de que cerremos MyKowalaWallet es casi nula. No nos cuesta prácticamente nada mantenerlo ya que no almacenamos ninguna información. Si borramos el dominio, continúa estando disponible y siempre lo estará en [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages). Puedes descargar desde ahí el archivo ZIP y ejecutarlo localmente. ',

HELP_8CX_Title              : '8) ¿Qué ocurre si MyKowalaWallet CX desaparece? ',
...
HELP_8CX_Desc_2             : 'Dicho esto, es **muy importante** que respaldes toda tu información para todas las nuevas carteras generadas con MyKowalaWallet CX. De este modo, si algo le ocurre a MyKowalaWallet CX o a tu equipo, seguirás teniendo toda la información necesaria para poder acceder a tus ether. Ver la pregunta #2a sobre cómo respaldar tus carteras. ',
HELP_8CX_Desc_3             : 'Si por algún motivo MyKowalaWallet CX desaparece de Chrome Store, puedes encontrar el código fuente en Github y cargarlo manualmente. Ver #5 más arriba. ',
...
HELP_10_Desc_11             : 'On your online computer, paste the signed transaction into the text field in step #3 and click "Enviar kUSD y Tokens". This will broadcast your transaction. ',
...
HELP_SecCX_Title            : 'Seguridad - MyKowalaWallet CX ',
...
HELP_SecCX_Desc_6           : 'Si cifráramos estos ítems, sería necesario que introduzcas una contraseña cada vez que quisieras comprobar el saldo de tu cuenta o vizualizar los alias. Si esto te preocupa, te recomendamos que utilices testnet-wallet.kowala.io en lugar de esta extensión de Chrome. ',
...
HELP_Sec_Desc_4             : 'Comprueba la URL -- Este sitio se sirve a través de GitHub y puedes ver el código fuente aquí: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) a [https://testnet-wallet.kowala.io](https://testnet-wallet.kowala.io). ',
