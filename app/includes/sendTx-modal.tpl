        ...
        <table class="table small table-condensed table-hover">
          <tbody>
            ...
            <tr>
              ...
              <td class="small text-left mono">{{parsedSignedTx.value}} kUSD</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="small text-left mono">{{parsedSignedTx.gasPrice.gwei}} GWEI <small>({{parsedSignedTx.gasPrice.eth}} kUSD)</small>
              </td>
            </tr>
            <tr>
              <td class="small text-right">Max TX Fee:</td>
              <td class="small text-left mono"> {{parsedSignedTx.txFee.eth}} kUSD <small>({{parsedSignedTx.txFee.gwei}} GWEI)</small></td>
            </tr>
            <tr>
