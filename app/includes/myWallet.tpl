      ...
      <td width="500" class="chrome-tokens">
        <h3 class="text-success point"
            ...
            title="{{twallet.balance}} (Double-Click)" >
              {{twallet.balance|number}} kUSD
        </h3>
        <h3 class="text-success point"
            ng-show="showLongBal"
            ng-dblclick="showLongBal=!showLongBal">
              {{twallet.balance }} kUSD
        </h3>
        <span class="point"
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p translate="MYWAL_Content_3">
            If you want to use this wallet with your MyKowalaWallet CX in the future, you will need to manually re-add.
          </p>
